!(function (e, t) {
  ...
  function e() {
    return (
      (t.Matrix = "undefined" != typeof Float32Array ? Float32Array : Array),
      t.Matrix
    );
  }
  var t = t || {},
  ...
  (t.InteractionManager = function () {}),
            ...
            for (t in e)
              (r = u[t]),
                ...
                u !== i &&
                  (l &&
                  i &&
                  (n.Utils.isPlainObject(i) || (s = Array.isArray(i)))
                    ? (s
                        ? ((s = !1), (o = r && Array.isArray(r) ? r : []))
                        : (o = r && n.Utils.isPlainObject(r) ? r : {}),
                      (u[t] = n.Utils.extend(l, o, i)))
                    : void 0 !== i && (u[t] = i));
        return u;
      },
    }),
    ...
    Object.defineProperty(t.DisplayObject.prototype, "mask", {
      ...
      set: function (e) {
        e
          ? this._mask
            ? ((e.start = this._mask.start), (e.end = this._mask.end))
            : (this.addFilter(e), (e.renderable = !1))
    ...
    (t.DisplayObject.prototype.addFilter = function (e) {
      ...
      (s = this.first._iPrev),
        ...
        (o._iPrev = s),
        (s._iNext = o);
      for (var a = this, f = this.last; a; )
        a.last === f && (a.last = r), (a = a.parent);
      (this.first = n),
        this.__renderGroup && this.__renderGroup.addFilterBlocks(n, r);
    }),
    (t.DisplayObject.prototype.removeFilter = function (e) {
      ...
      for (
        var s = i._iPrev, o = this;
        o.last === i && ((o.last = s), (o = o.parent));
    ...
    (t.DisplayObject.prototype.updateTransform = function () {
      ...
      (e[0] = this._cr * this.scale.x),
        (e[1] = -this._sr * this.scale.y),
        (e[3] = this._sr * this.scale.x),
        (e[4] = this._cr * this.scale.y);
      var i = this.pivot.x,
        s = this.pivot.y,
        o = e[0],
        u = e[1],
    ...
    (t.DisplayObjectContainer.prototype.addChild = function (e) {
      if (
        (e.parent && e.parent !== this && e.parent.removeChild(e),
        (e.parent = this),
        ...
        var t = e;
        do
          t.interactive && (this.stage.dirty = !0),
            (t.stage = this.stage),
            (t = t._iNext);
        while (t);
      }
      var n,
        ...
        i = e.first,
        s = e.last;
      (r = this._filters || this._mask ? this.last._iPrev : this.last),
        (n = r._iNext);
      for (var o = this, u = r; o; )
        o.last === u && (o.last = e.last), (o = o.parent);
      n && ((n._iPrev = s), (s._iNext = n)),
        (i._iPrev = r),
        (r._iNext = i),
        this.__renderGroup &&
          (e.__renderGroup && e.__renderGroup.removeDisplayObjectAndChildren(e),
          this.__renderGroup.addDisplayObjectAndChildren(e));
    }),
    (t.DisplayObjectContainer.prototype.addChildAt = function (e, t) {
      ...
      if (
        ...
        var n = e;
        do
          n.interactive && (this.stage.dirty = !0),
            (n.stage = this.stage),
            (n = n._iNext);
        while (n);
      }
      ...
      if (t === this.children.length) {
        i = this.last;
        for (var u = this, a = this.last; u; )
          u.last === a && (u.last = e.last), (u = u.parent);
    ...
    (t.DisplayObjectContainer.prototype.swapChildren = function (e, t) {
      if (e !== t) {
        ...
        this.removeChild(e),
          this.removeChild(t),
          r > n
            ? (this.addChildAt(t, n), this.addChildAt(e, r))
            : (this.addChildAt(e, r), this.addChildAt(t, n));
      }
    }),
    (t.DisplayObjectContainer.prototype.getChildAt = function (e) {
      if (e >= 0 && e < this.children.length) return this.children[e];
      throw new Error(
        "Both the supplied DisplayObjects must be a child of the caller " + this
      );
    }),
    (t.DisplayObjectContainer.prototype.removeChild = function (e) {
      ...
      var n = e.first,
        ...
        i = r._iNext,
        s = n._iPrev;
      if ((i && (i._iPrev = s), (s._iNext = i), this.last === r))
        for (
          var o = n._iPrev, u = this;
          u.last === r && ((u.last = o), (u = u.parent));

        );
      if (((r._iNext = null), (n._iPrev = null), this.stage)) {
        var a = e;
        do
          a.interactive && (this.stage.dirty = !0),
            (a.stage = null),
            (a = a._iNext);
        while (a);
      }
    ...
    (t.Rope = function (e, n) {
      ...
      try {
        (this.verticies = new Float32Array(4 * n.length)),
          (this.uvs = new Float32Array(4 * n.length)),
          (this.colors = new Float32Array(2 * n.length)),
          (this.indices = new Uint16Array(2 * n.length));
      } catch (r) {
        (this.verticies = new Array(4 * n.length)),
          (this.uvs = new Array(4 * n.length)),
          (this.colors = new Array(2 * n.length)),
          (this.indices = new Array(2 * n.length));
      }
      this.refresh();
    }),
    ...
    (t.TilingSprite.prototype = Object.create(
    ...
    (t.Graphics.prototype.updateFilterBounds = function () {
      if (!this.bounds) {
        for (
          var e, n, r, i = 1 / 0, s = -1 / 0, o = 1 / 0, u = -1 / 0, a = 0;
          a < this.graphicsData.length;
          a++
        ) {
    ...
    (t.CanvasRenderer.prototype.render = function (e) {
      (t.texturesToUpdate = []),
        ...
        t.visibleCount++,
        e.updateTransform(),
        this.view.style.backgroundColor === e.backgroundColorString ||
          this.transparent ||
          (this.view.style.backgroundColor = e.backgroundColorString),
          ...
          if (e.renderable) {
            if (e instanceof t.Sprite) {
              ...
              s &&
                ...
                this.smoothProperty &&
                  this.scaleMode !== e.texture.baseTexture.scaleMode &&
                  ((this.scaleMode = e.texture.baseTexture.scaleMode),
                  (r[this.smoothProperty] =
                    this.scaleMode === t.BaseTexture.SCALE_MODE.LINEAR)),
                r.drawImage(
                  e.texture.baseTexture.source,
                  s.x,
                  s.y,
            ...
            } else if (e instanceof t.Strip)
              r.setTransform(n[0], n[3], n[1], n[4], n[2], n[5]),
                this.renderStrip(e);
            else if (e instanceof t.TilingSprite)
              r.setTransform(n[0], n[3], n[1], n[4], n[2], n[5]),
                this.renderTilingSprite(e);
            else if (e instanceof t.CustomRenderable)
              r.setTransform(n[0], n[3], n[1], n[4], n[2], n[5]),
                e.renderCanvas(this);
            else if (e instanceof t.Graphics)
              r.setTransform(n[0], n[3], n[1], n[4], n[2], n[5]),
                t.CanvasGraphics.renderGraphics(e, r);
            else if (
              e instanceof t.FilterBlock &&
              e.data instanceof t.Graphics
            ) {
              var o = e.data;
              if (e.open) {
                r.save();
                var u = o.alpha,
                  a = o.worldTransform;
                r.setTransform(a[0], a[3], a[1], a[4], a[2], a[5]),
                  (o.worldAlpha = 0.5),
                  (r.worldAlpha = 0),
                  t.CanvasGraphics.renderGraphicsMask(o, r),
                  r.clip(),
                  (o.worldAlpha = u);
              } else r.restore();
            }
    ...
    (t.CanvasRenderer.prototype.renderTilingSprite = function (e) {
      var t = this.context;
      (t.globalAlpha = e.worldAlpha),
        e.__tilePattern ||
          (e.__tilePattern = t.createPattern(
            e.texture.baseTexture.source,
            "repeat"
          )),
        t.beginPath();
      ...
      t.scale(r.x, r.y),
        t.translate(n.x, n.y),
        (t.fillStyle = e.__tilePattern),
        t.fillRect(-n.x, -n.y, e.width / r.x, e.height / r.y),
        t.scale(1 / r.x, 1 / r.y),
        t.translate(-n.x, -n.y),
        t.closePath();
    }),
    ...
    (t.PixiShader.prototype.init = function () {
      ...
      for (var r in this.uniforms)
        this.uniforms[r].uniformLocation = n.getUniformLocation(e, r);
      ...
      for (var n in this.uniforms) {
        ...
        "sampler2D" === r
          ...
          ? ((e.glMatrix = !0),
            (e.glValueLength = 1),
            "mat2" === r
              ? (e.glFunc = t.gl.uniformMatrix2fv)
              : "mat3" === r
              ? (e.glFunc = t.gl.uniformMatrix3fv)
              : "mat4" === r && (e.glFunc = t.gl.uniformMatrix4fv))
          : ((e.glFunc = t.gl["uniform" + r]),
            (e.glValueLength =
              "2f" === r || "2i" === r
                ? 2
                : "3f" === r || "3i" === r
    ...
    (t.PixiShader.prototype.initSampler2D = function (e) {
      if (e.value && e.value.baseTexture && e.value.baseTexture.hasLoaded) {
        if (
          (t.gl.activeTexture(t.gl["TEXTURE" + this.textureCount]),
          t.gl.bindTexture(t.gl.TEXTURE_2D, e.value.baseTexture._glTexture),
          e.textureData)
        ) {
          var n = e.textureData,
          ...
          if (
            (n.repeat && ((s = t.gl.REPEAT), (o = t.gl.REPEAT)),
            t.gl.pixelStorei(t.gl.UNPACK_FLIP_Y_WEBGL, !1),
            n.width)
          ) {
        ...
        t.gl.uniform1i(e.uniformLocation, this.textureCount),
          (e._init = !0),
          this.textureCount++;
      }
    }),
            ...
            : "sampler2D" === e.type &&
              (e._init
                ? (t.gl.activeTexture(t.gl["TEXTURE" + this.textureCount]),
                  t.gl.bindTexture(
                    t.gl.TEXTURE_2D,
                    e.value.baseTexture._glTexture
                  ),
                  t.gl.uniform1i(e.uniformLocation, this.textureCount),
                  this.textureCount++)
    ...
    (t._restoreBatchs = function (e) {
      for (var n = 0; n < t._batchs.length; n++)
        t._batchs[n].restoreLostContext(e);
    }),
    ...
    (t.WebGLBatch.prototype.insertBefore = function (e, t) {
      ...
      (t.__prev = e),
        (e.__next = t),
        n ? ((e.__prev = n), (n.__next = e)) : (this.head = e);
    }),
    (t.WebGLBatch.prototype.insertAfter = function (e, t) {
      ...
      (t.__next = e),
        (e.__prev = t),
        n ? ((e.__next = n), (n.__prev = e)) : (this.tail = e);
    }),
    (t.WebGLBatch.prototype.remove = function (e) {
      return (
        ...
        0 === this.size
          ...
          : (e.__prev
              ? (e.__prev.__next = e.__next)
              : ((this.head = e.__next), (this.head.__prev = null)),
            e.__next
              ? (e.__next.__prev = e.__prev)
              : ((this.tail = e.__prev), (this.tail.__next = null)),
            (e.batch = null),
            (e.__next = null),
            (e.__prev = null),
            void (this.dirty = !0))
    ...
    (t.WebGLBatch.prototype.merge = function (e) {
      (this.dirty = !0),
        (this.tail.__next = e.head),
        (e.head.__prev = this.tail),
        (this.size += e.size),
        (this.tail = e.tail);
      ...
      for (
        ...
        if (y.vcount === t.visibleCount) {
          ...
          if (y.cacheAlpha !== y.worldAlpha) {
            ...
            var C = 4 * g;
            (E[C] = E[C + 1] = E[C + 2] = E[C + 3] = y.worldAlpha),
              (this.dirtyColors = !0);
          }
        } else
          (l = 8 * g),
    ...
    (t.WebGLBatch.prototype.render = function (e, n) {
      if (
        ...
        r.bindBuffer(r.ARRAY_BUFFER, this.vertexBuffer),
          ...
          this.dirtyUVS &&
            ((this.dirtyUVS = !1),
            r.bufferSubData(r.ARRAY_BUFFER, 0, this.uvs)),
          ...
          this.dirtyColors &&
            ((this.dirtyColors = !1),
            r.bufferSubData(r.ARRAY_BUFFER, 0, this.colors)),
    ...
    (t.WebGLFilterManager.prototype.pushFilter = function (e) {
      ...
      i
        ...
        : (i = new t.FilterTexture(this.width, this.height)),
        n.bindTexture(n.TEXTURE_2D, i.texture),
        this.getBounds(e.target);
      ...
      (s.x -= o),
        ...
        (t.offset.y = -s.y),
        n.uniform2f(
          t.defaultShader.projectionVector,
          s.width / 2,
          -s.height / 2
        ),
    ...
    (t.WebGLFilterManager.prototype.popFilter = function () {
      ...
      if (n.filterPasses.length > 1) {
        ...
        o || (o = new t.FilterTexture(this.width, this.height)),
        ...
        for (var u = 0; u < n.filterPasses.length - 1; u++) {
          ...
          e.bindFramebuffer(e.FRAMEBUFFER, o.frameBuffer),
            ...
            this.applyFilterPass(a, r, r.width, r.height);
          var f = s;
          (s = o), (o = f);
        }
    ...
    (t.WebGLFilterManager.prototype.getBounds = function (e) {
      ...
      do {
        if (C.visible)
          if (C instanceof t.Sprite)
            (r = C.texture.frame.width),
              (i = C.texture.frame.height),
              (s = C.anchor.x),
              (o = C.anchor.y),
              (u = r * (1 - s)),
              (a = r * -s),
      ...
      (e.filterArea.x = O),
        (e.filterArea.y = M),
        (e.filterArea.width = L - O),
        (e.filterArea.height = A - M);
    }),
    ...
    (t.WebGLGraphics.renderGraphics = function (e, n) {
      ...
      e._webGL ||
        ...
        e.dirty &&
          ...
          e.clearDirty &&
            ((e.clearDirty = !1),
            (e._webGL.lastIndex = 0),
            (e._webGL.points = []),
            (e._webGL.indices = [])),
          t.WebGLGraphics.updateGraphics(e)),
      ...
      t.mat3.transpose(i),
        ...
        r.vertexAttribPointer(
          t.primitiveShader.aVertexPosition,
          2,
          r.FLOAT,
          !1,
          24,
        ...
        r.vertexAttribPointer(
          t.primitiveShader.colorAttribute,
          4,
          r.FLOAT,
          !1,
          24,
    ...
    (t.WebGLGraphics.updateGraphics = function (e) {
      for (var n = e._webGL.lastIndex; n < e.graphicsData.length; n++) {
        ...
        r.type === t.Graphics.POLY
          ? (r.fill &&
              r.points.length > 3 &&
              t.WebGLGraphics.buildPoly(r, e._webGL),
            r.lineWidth > 0 && t.WebGLGraphics.buildLine(r, e._webGL))
          : r.type === t.Graphics.RECT
          ? t.WebGLGraphics.buildRectangle(r, e._webGL)
          : (r.type === t.Graphics.CIRC || r.type === t.Graphics.ELIP) &&
            t.WebGLGraphics.buildCircle(r, e._webGL);
      }
    ...
    (t.WebGLRenderer = function (e, n, r, i, s) {
      ...
      l.useProgram(t.defaultShader.program),
        ...
        (this.contextLost = !1),
        (this.stageRenderGroup = new t.WebGLRenderGroup(
          this.gl,
          this.transparent
        ));
    }),
    ...
    (t.WebGLRenderer.getBatch = function () {
      return 0 === t._batchs.length
        ? new t.WebGLBatch(t.WebGLRenderer.gl)
        : t._batchs.pop();
    }),
    ...
    (t.WebGLRenderer.prototype.render = function (e) {
      if (!this.contextLost) {
        this.__stage !== e &&
          ((this.__stage = e), this.stageRenderGroup.setRenderable(e)),
        ...
        if (
          ...
          for (var r = 0; r < t.Texture.frameUpdates.length; r++)
            t.Texture.frameUpdates[r].updateFrame = !1;
    ...
    (t.WebGLRenderer.updateTextures = function () {
      var e = 0;
      for (e = 0; e < t.texturesToUpdate.length; e++)
        t.WebGLRenderer.updateTexture(t.texturesToUpdate[e]);
      ...
      e._glTexture || (e._glTexture = n.createTexture()),
        e.hasLoaded &&
          ...
          n.texParameteri(
            ...
            e.scaleMode === t.BaseTexture.SCALE_MODE.LINEAR
              ? n.LINEAR
              : n.NEAREST
          ),
          n.texParameteri(
    ...
    (t.WebGLRenderer.destroyTexture = function (e) {
      var n = t.gl;
      e._glTexture &&
        ((e._glTexture = n.createTexture()),
        n.deleteTexture(n.TEXTURE_2D, e._glTexture));
    }),
    ...
    (t.WebGLRenderer.prototype.handleContextRestored = function () {
      ...
      for (var r = 0; r < this.batchs.length; r++)
        this.batchs[r].restoreLostContext(this.gl), (this.batchs[r].dirty = !0);
    ...
    (t.WebGLRenderGroup = function (e, n) {
      (this.gl = e),
        ...
        (this.transparent = void 0 == n ? !0 : n),
        (this.batchs = []),
        (this.toRemove = []),
        (this.filterManager = new t.WebGLFilterManager(this.transparent));
    }),
    ...
    (t.WebGLRenderGroup.prototype.setRenderable = function (e) {
      this.root && this.removeDisplayObjectAndChildren(this.root),
        (e.worldVisible = e.visible),
        (this.root = e),
        this.addDisplayObjectAndChildren(e);
    }),
    (t.WebGLRenderGroup.prototype.render = function (e, n) {
      t.WebGLRenderer.updateTextures();
      var r = this.gl;
      r.uniform2f(t.defaultShader.projectionVector, e.x, e.y),
        this.filterManager.begin(e, n),
        r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA);
      for (var i, s = 0; s < this.batchs.length; s++)
        (i = this.batchs[s]),
          i instanceof t.WebGLBatch
            ? this.batchs[s].render()
            : this.renderSpecial(i, e);
    }),
    (t.WebGLRenderGroup.prototype.renderSpecific = function (e, n, r) {
      t.WebGLRenderer.updateTextures();
      var i = this.gl;
      i.uniform2f(t.defaultShader.projectionVector, n.x, n.y),
        this.filterManager.begin(n, r);
      for (
        var s, o, u, a, f = e.first;
        f._iNext && (!f.renderable || !f.__renderGroup);
      ...
      for (var h = e.last; h._iPrev && (!h.renderable || !h.__renderGroup); )
        h = h._iNext;
      ...
      if (l == endBatch)
        return void (l instanceof t.WebGLBatch
          ? l.render(s, u + 1)
          : this.renderSpecial(l, n));
      (o = this.batchs.indexOf(l)),
        (a = this.batchs.indexOf(endBatch)),
        l instanceof t.WebGLBatch ? l.render(s) : this.renderSpecial(l, n);
      for (var p = o + 1; a > p; p++)
        (renderable = this.batchs[p]),
          renderable instanceof t.WebGLBatch
            ? this.batchs[p].render()
            : this.renderSpecial(renderable, n);
      endBatch instanceof t.WebGLBatch
        ? endBatch.render(0, u + 1)
        : this.renderSpecial(endBatch, n);
    }),
  ...
  return (
    ...
    (t.WebGLRenderGroup.prototype.updateTexture = function (e) {
      ...
      for (
        var t = e.first;
        t != this.root && ((t = t._iPrev), !t.renderable || !t.__renderGroup);

      );
      for (
        var n = e.last;
        n._iNext && ((n = n._iNext), !n.renderable || !n.__renderGroup);
    ...
    (t.WebGLRenderGroup.prototype.addFilterBlocks = function (e, t) {
      ...
      for (
        var n = e;
        n != this.root.first &&
        ((n = n._iPrev), !n.renderable || !n.__renderGroup);
      ...
      for (
        var r = t;
        r != this.root.first &&
        ((r = r._iPrev), !r.renderable || !r.__renderGroup);
    ...
    (t.WebGLRenderGroup.prototype.addDisplayObjectAndChildren = function (e) {
      ...
      for (
        var t = e.first;
        t != this.root.first &&
        ((t = t._iPrev), !t.renderable || !t.__renderGroup);
      ...
      var r = e.first,
        i = e.last._iNext;
      do
        (r.__renderGroup = this),
          r.renderable && (this.insertObject(r, t, n), (t = r)),
          (r = r._iNext);
      while (r != i);
    }),
    (t.WebGLRenderGroup.prototype.removeDisplayObjectAndChildren = function (
      e
    ) {
      if (e.__renderGroup == this) {
        ...
        do
          (e.__renderGroup = null),
            e.renderable && this.removeObject(e),
            (e = e._iNext);
        while (e);
      }
    }),
      ...
      if (e instanceof t.Sprite) {
        ...
        if (i instanceof t.Sprite) {
          if (
            ((o = i.batch),
            o &&
              o.texture == e.texture.baseTexture &&
              o.blendMode == e.blendMode)
          )
            return void o.insertAfter(e, i);
        } else o = i;
        if (s)
          if (s instanceof t.Sprite) {
            if ((u = s.batch)) {
              if (
                u.texture == e.texture.baseTexture &&
                u.blendMode == e.blendMode
              )
                return void u.insertBefore(e, s);
              if (u == o) {
                var a = o.split(s),
        ...
        e instanceof t.TilingSprite
          ? this.initTilingSprite(e)
          : e instanceof t.Strip && this.initStrip(e),
    ...
    (t.WebGLRenderGroup.prototype.removeObject = function (e) {
      ...
      if (n) {
        var i = this.batchs.indexOf(n);
        if (-1 == i) return;
        if (0 == i || i == this.batchs.length - 1)
          return (
            this.batchs.splice(i, 1),
            void (n instanceof t.WebGLBatch && t.WebGLRenderer.returnBatch(n))
          );
        if (
          this.batchs[i - 1] instanceof t.WebGLBatch &&
          this.batchs[i + 1] instanceof t.WebGLBatch &&
          this.batchs[i - 1].texture == this.batchs[i + 1].texture &&
          this.batchs[i - 1].blendMode == this.batchs[i + 1].blendMode
        )
          return (
            this.batchs[i - 1].merge(this.batchs[i + 1]),
            n instanceof t.WebGLBatch && t.WebGLRenderer.returnBatch(n),
            t.WebGLRenderer.returnBatch(this.batchs[i + 1]),
            void this.batchs.splice(i, 2)
          );
        this.batchs.splice(i, 1),
          n instanceof t.WebGLBatch && t.WebGLRenderer.returnBatch(n);
      }
    ...
    (t.WebGLRenderGroup.prototype.initTilingSprite = function (e) {
      ...
      (e.verticies = new Float32Array([
        ...
        e.texture.baseTexture._glTexture
          ? (t.bindTexture(t.TEXTURE_2D, e.texture.baseTexture._glTexture),
    ...
    (t.initDefaultShaders = function () {
      (t.primitiveShader = new t.PrimitiveShader()),
        t.primitiveShader.init(),
        (t.stripShader = new t.StripShader()),
        t.stripShader.init(),
        (t.defaultShader = new t.PixiShader()),
        t.defaultShader.init();
      var e = t.gl,
    ...
    (t.BitmapText.prototype.updateText = function () {
      ...
      for (f = 0; f < i.length; f++) {
        ...
        (d.position.x = (i[f].position.x + h[i[f].line]) * a),
          (d.position.y = i[f].position.y * a),
          (d.scale.x = d.scale.y = a),
          this.addChild(d);
      }
    ...
    (t.BaseTexture = function (e, n) {
      if (
        ...
        (this.width = 100),
        (this.height = 100),
        (this.scaleMode = n || t.BaseTexture.SCALE_MODE.DEFAULT),
        (this.hasLoaded = !1),
        (this.source = e),
        e)
      ) {
    ...
    (t.BaseTexture.prototype.destroy = function () {
      this.source instanceof Image &&
        (this.imageUrl in t.BaseTextureCache &&
    ...
    (t.RenderTexture.prototype.resize = function (e, n) {
      if (((this.width = e), (this.height = n), t.gl)) {
        ...
        var r = t.gl;
        r.bindTexture(r.TEXTURE_2D, this.baseTexture._glTexture),
          r.texImage2D(
            r.TEXTURE_2D,
            0,
            r.RGBA,
    ...
    (t.RenderTexture.prototype.initCanvas = function () {
      (this.renderer = new t.CanvasRenderer(this.width, this.height, null, 0)),
        (this.baseTexture = new t.BaseTexture(this.renderer.view)),
        (this.frame = new t.Rectangle(0, 0, this.width, this.height)),
    ...
    (t.RenderTexture.prototype.renderWebGL = function (e, n, r) {
      ...
      i.colorMask(!0, !0, !0, !0),
        ...
        i.bindFramebuffer(i.FRAMEBUFFER, this.glFramebuffer),
        r && (i.clearColor(0, 0, 0, 0), i.clear(i.COLOR_BUFFER_BIT));
      var s = e.children,
        o = e.worldTransform;
      (e.worldTransform = t.mat3.create()),
        (e.worldTransform[4] = -1),
        (e.worldTransform[5] = -2 * this.projection.y),
        n && ((e.worldTransform[2] = n.x), (e.worldTransform[5] -= n.y)),
        t.visibleCount++,
        (e.vcount = t.visibleCount);
      ...
      f
        ...
        : (this.renderGroup || (this.renderGroup = new t.WebGLRenderGroup(i)),
          this.renderGroup.setRenderable(e),
    ...
    (t.RenderTexture.prototype.renderCanvas = function (e, n, r) {
      ...
      r && this.renderer.context.clearRect(0, 0, this.width, this.height),
        this.renderer.renderDisplayObject(e),
        ...
        (this.dispatchEvent = this.emit =
          function (t) {
            if (e[t.type] && e[t.type].length)
              for (var n = 0, r = e[t.type].length; r > n; n++) e[t.type][n](t);
          }),
        ...
        if (t.PolyK._convex(c, h, p, d, v, m, n)) {
          ...
          for (var y = 0; u > y; y++) {
            ...
            if (
              ...
              b !== f &&
              b !== l &&
              t.PolyK._PointInTriangle(e[2 * b], e[2 * b + 1], c, h, p, d, v, m)
            ) {
              g = !1;
              break;
            }
    ...
    (n.Camera.prototype = {
      follow: function (e, t) {
        "undefined" == typeof t && (t = n.Camera.FOLLOW_LOCKON),
          (this.target = e);
        var r;
        switch (t) {
    ...
    (n.StateManager.prototype = {
      ...
      add: function (e, t, r) {
        ...
        var i;
        return (
          t instanceof n.State
            ? (i = t)
            : "object" == typeof t
            ? ((i = t), (i.game = this.game))
            : "function" == typeof t && (i = new t(this.game)),
          (this.states[e] = i),
    ...
    (n.Signal.prototype = {
      ...
      _registerListener: function (e, t, r, i) {
        ...
        if (-1 !== o) {
          if (((s = this._bindings[o]), s.isOnce() !== t))
            throw new Error(
              "You cannot add" +
                (t ? "" : "Once") +
                "() then add" +
    ...
    (n.Stage.prototype = {
      parseConfig: function (e) {
        (this.canvas = e.canvasID
          ? n.Canvas.create(this.game.width, this.game.height, e.canvasID)
          : n.Canvas.create(this.game.width, this.game.height)),
          e.canvasStyle
            ? (this.canvas.stlye = e.canvasStyle)
            : (this.canvas.style["-webkit-full-screen"] =
                "width: 100%; height: 100%"),
      ...
      boot: function () {
        n.Canvas.getOffset(this.canvas, this.offset),
          (this.bounds = new n.Rectangle(
            this.offset.x,
            this.offset.y,
            this.game.width,
            this.game.height
      ...
      set: function (e) {
        (this._backgroundColor = e),
          this.game.transparent === !1 &&
            (this.game.renderType == n.CANVAS
              ? (this.game.canvas.style.backgroundColor = e)
              : ("string" == typeof e && (e = n.Color.hexToRGB(e)),
                this._stage.setBackgroundColor(e)));
      },
    }),
      ...
      (this.game = e),
        ...
        s
          ...
          : ((this._container = new t.DisplayObjectContainer()),
            ...
            r
              ? r instanceof n.Group
                ? r._container.addChild(this._container)
                : (r.addChild(this._container), r.updateTransform())
    ...
    (n.Group.prototype = {
        ...
        return (
          e.group !== this &&
            (e.type && e.type === n.GROUP
              ? ((e.group = this),
                this._container.addChild(e._container),
      ...
      addAt: function (e, t) {
        return (
          e.group !== this &&
            (e.type && e.type === n.GROUP
              ? ((e.group = this),
                this._container.addChildAt(e._container, t),
                e._container.updateTransform())
              : ((e.group = this),
                this._container.addChildAt(e, t),
                e.updateTransform(),
                e.events && e.events.onAddedToGroup.dispatch(e, this)),
            null === this.cursor && (this.cursor = e)),
          e
      ...
      childTest: function (e, t) {
        var n = e + " next: ";
        (n += t._iNext ? t._iNext.name : "-null-"),
          (n = n + " " + e + " prev: "),
          (n += t._iPrev ? t._iPrev.name : "-null-"),
          console.log(n);
      },
      ...
      swap: function (e, t) {
        ...
        do
          u !== e &&
            u !== t &&
            (u.first === e ? (u.first = t) : u.first === t && (u.first = e),
            u.last === e ? (u.last = t) : u.last === t && (u.last = e)),
            (u = u._iNext);
        while (u != o);
        return e._iNext == t
          ? ((e._iNext = s),
      ...
      callAll: function (e, t) {
        if ("undefined" != typeof e) {
          ...
          if (
            ...
            do
              (s = this.callbackFromArray(u, e, n)),
                t && s
                  ? ((o = this.callbackFromArray(u, t, r)), s && s.apply(o, i))
                  : s && s.apply(u, i),
                (u = u._iNext);
      ...
      forEach: function (e, t, n) {
        ...
        if (
          ...
          do
            (n === !1 || (n && i.exists)) && ((r[0] = i), e.apply(t, r)),
              (i = i._iNext);
      ...
      forEachExists: function (e, t) {
        ...
        r.unshift(null),
          this.iterate("exists", !0, n.Group.RETURN_TOTAL, e, t, r);
      },
      forEachAlive: function (e, t) {
        var r = Array.prototype.splice.call(arguments, 2);
        r.unshift(null),
          this.iterate("alive", !0, n.Group.RETURN_TOTAL, e, t, r);
      },
      forEachDead: function (e, t) {
        var r = Array.prototype.splice.call(arguments, 2);
        r.unshift(null),
          this.iterate("alive", !1, n.Group.RETURN_TOTAL, e, t, r);
      },
      sort: function (e, t) {
        "undefined" == typeof e && (e = "y"),
          "undefined" == typeof t && (t = n.Group.SORT_ASCENDING);
        var r, i;
        do {
          r = !1;
          for (var s = 0, o = this._container.children.length - 1; o > s; s++)
            t == n.Group.SORT_ASCENDING
              ? this._container.children[s][e] >
                  this._container.children[s + 1][e] &&
                (this.swap(this.getAt(s), this.getAt(s + 1)),
                (i = this._container.children[s]),
                (this._container.children[s] = this._container.children[s + 1]),
                (this._container.children[s + 1] = i),
                (r = !0))
              : this._container.children[s][e] <
                  this._container.children[s + 1][e] &&
                (this.swap(this.getAt(s), this.getAt(s + 1)),
      ...
      iterate: function (e, t, r, i, s, o) {
        if (r === n.Group.RETURN_TOTAL && 0 === this._container.children.length)
          return 0;
        "undefined" == typeof i && (i = !1);
        var u = 0;
        if (
          ...
          do {
            if (
              ...
              (u++,
              i && ((o[0] = a), i.apply(s, o)),
              r === n.Group.RETURN_CHILD)
            )
              return a;
            a = a._iNext;
          } while (a != this._container.last._iNext);
        }
        return r === n.Group.RETURN_TOTAL
          ? u
          : r === n.Group.RETURN_CHILD
          ? null
          : void 0;
      ...
      getFirstExists: function (e) {
        return (
          ...
          this.iterate("exists", e, n.Group.RETURN_CHILD)
        );
      },
      ...
      getRandom: function (e, t) {
        return 0 === this._container.children.length
          ? null
          : ((e = e || 0),
            (t = t || this._container.children.length),
            this.game.math.getRandom(this._container.children, e, t));
      },
      remove: function (e) {
        return e.group !== this
          ? !1
      ...
      removeBetween: function (e, t) {
        if (0 !== this._container.children.length) {
          ...
          for (var n = e; t > n; n++) {
            ...
            r.events.onRemovedFromGroup.dispatch(r, this),
    ...
    Object.defineProperty(n.Group.prototype, "total", {
      get: function () {
        return this._container
          ? this.iterate("exists", !0, n.Group.RETURN_TOTAL)
          : 0;
      },
    }),
    ...
    (n.World = function (e) {
      n.Group.call(this, e, null, "__world", !1),
        (this.bounds = new n.Rectangle(0, 0, e.width, e.height)),
        (this.camera = null),
    ...
    (n.World.prototype.postUpdate = function () {
      if (this.camera.target && this.camera.target.postUpdate) {
        if (
          ...
          var e = this.game.stage._stage.first._iNext;
          do
            e.postUpdate && e !== this.camera.target && e.postUpdate(),
              (e = e._iNext);
          while (e != this.game.stage._stage.last._iNext);
        }
    ...
    (n.Game.prototype = {
      ...
      parseDimension: function (e, t) {
        ...
        return (
          "string" == typeof e
            ? "%" === e.substr(-1)
              ? ((n = parseInt(e, 10) / 100),
                (r = 0 === t ? window.innerWidth * n : window.innerHeight * n))
              : (r = parseInt(e, 10))
            : (r = e),
          r
        );
        ...
        this.isBooted ||
          (document.body
            ? (document.removeEventListener("DOMContentLoaded", this._onBoot),
              ...
              (this.math = n.Math),
              (this.rnd = new n.RandomDataGenerator([
      ...
      showDebugHeader: function () {
        var e = n.DEV_VERSION,
          ...
          r = "HTML Audio";
        if (
          (this.renderType == n.WEBGL
            ? (t = "WebGL")
            : this.renderType == n.HEADLESS && (t = "Headless"),
          this.device.webAudio && (r = "WebAudio"),
          this.device.chrome)
        ) {
          var i = [
            "%c %c %c  Phaser v" +
          ...
          console.log("Phaser v" + e + " - Renderer: " + t + " - Audio: " + r);
      },
      setUpRenderer: function () {
        if (
          this.renderType === n.HEADLESS ||
          this.renderType === n.CANVAS ||
          (this.renderType === n.AUTO && this.device.webGL === !1)
        ) {
          ...
          (this.renderType = n.WEBGL),
            ...
            (this.canvas = this.renderer.view),
            (this.context = null);
        n.Canvas.addToDOM(this.renderer.view, this.parent, !0),
          n.Canvas.setTouchAction(this.renderer.view);
      },
      loadComplete: function () {
    ...
    (n.Input.prototype = {
      ...
      addPointer: function () {
        for (var e = 0, t = 10; t > 0; t--)
          null === this["pointer" + t] && (e = t);
        return 0 === e
          ? (console.warn("You can only have 10 Pointer objects"), null)
          : ((this["pointer" + e] = new n.Pointer(this.game, e)),
            this["pointer" + e]);
      },
      update: function () {
      ...
      reset: function (e) {
        if (this.game.isBooted !== !1) {
          "undefined" == typeof e && (e = !1),
            ...
            this.gamepad.reset();
          for (var t = 1; 10 >= t; t++)
            this["pointer" + t] && this["pointer" + t].reset();
          (this.currentPointers = 0),
    ...
    (n.Key.prototype = {
      processKeyDown: function (e) {
        (this.altKey = e.altKey),
          ...
          this.isDown
            ? ((this.duration = e.timeStamp - this.timeDown), this.repeats++)
            : ((this.isDown = !0),
              (this.isUp = !1),
      ...
      justPressed: function (e) {
        return (
          "undefined" == typeof e && (e = 250), this.isDown && this.duration < e
        );
      },
    ...
    (n.Keyboard.prototype = {
      ...
      addKey: function (e) {
        return (
          (this._hotkeys[e] = new n.Key(this.game, e)),
      ...
      processKeyDown: function (e) {
        this.game.input.disabled ||
          ...
          this._keys[e.keyCode] && this._keys[e.keyCode].isDown
            ? (this._keys[e.keyCode].duration =
                this.game.time.now - this._keys[e.keyCode].timeDown)
            : this._keys[e.keyCode]
            ? ((this._keys[e.keyCode].isDown = !0),
              (this._keys[e.keyCode].timeDown = this.game.time.now),
              (this._keys[e.keyCode].duration = 0))
            : (this._keys[e.keyCode] = {
                isDown: !0,
          ...
          this._hotkeys[e.keyCode] &&
            this._hotkeys[e.keyCode].processKeyDown(e));
      },
      processKeyUp: function (e) {
        this.game.input.disabled ||
          this.disabled ||
          ...
          this._keys[e.keyCode]
            ? ((this._keys[e.keyCode].isDown = !1),
              (this._keys[e.keyCode].timeUp = this.game.time.now))
            : (this._keys[e.keyCode] = {
                isDown: !1,
                timeDown: this.game.time.now,
      ...
      justPressed: function (e, t) {
        return (
          ...
          this._keys[e] && this._keys[e].isDown && this._keys[e].duration < t
            ? !0
            : !1
        );
      },
      justReleased: function (e, t) {
        return (
          "undefined" == typeof t && (t = 250),
          this._keys[e] &&
          this._keys[e].isDown === !1 &&
          this.game.time.now - this._keys[e].timeUp < t
            ? !0
            : !1
        );
      },
          ...
          this.game.stage.scale.incorrectOrientation === !1
            ...
            : ((this._history.length = 0),
              ...
              (this.game.input.multiInputOverride ==
                ...
                this.game.input.multiInputOverride ==
                  n.Input.MOUSE_TOUCH_COMBINE ||
                (this.game.input.multiInputOverride ==
                  n.Input.TOUCH_OVERRIDES_MOUSE &&
      ...
      move: function (e) {
        if (!this.game.input.pollLocked) {
          ...
          if (
            ...
            do
              (t.pixelPerfect ||
                t.priorityID > this._highestInputPriorityID ||
                (t.priorityID == this._highestInputPriorityID &&
                  t.sprite.renderOrderID > this._highestRenderOrderID)) &&
                t.checkPointerOver(this) &&
                ((this._highestRenderOrderID = t.sprite.renderOrderID),
                (this._highestInputPriorityID = t.priorityID),
                (this._highestRenderObject = t)),
                (t = t.next);
            while (null != t);
          }
          return (
      ...
      _releasedHandler: function (e) {
        this._pointerData[e.id].isDown &&
          ...
          (this._pointerData[e.id].downDuration =
            this._pointerData[e.id].timeUp - this._pointerData[e.id].timeDown),
          this.checkPointerOver(e)
        ...
        this.sprite.fixedToCamera && this.boundsSprite.fixedToCamera
          ? (this.sprite.cameraOffset.x < this.boundsSprite.camerOffset.x
            ...
            this.sprite.cameraOffset.y < this.boundsSprite.camerOffset.y
              ? (this.sprite.cameraOffset.y = this.boundsSprite.camerOffset.y)
              : this.sprite.cameraOffset.y + this.sprite.height >
                  this.boundsSprite.camerOffset.y + this.boundsSprite.height &&
                (this.sprite.cameraOffset.y =
      ...
      addCallbacks: function (e, t) {
        "undefined" != typeof t &&
          ...
          (this.onFloatCallback =
            "function" == typeof t.onFloat ? t.onFloat : this.onFloatCallback));
      },
      start: function () {
        this._active = !0;
        var e = this;
    ...
    (n.SinglePad.prototype = {
      ...
      addButton: function (e) {
        return (
          (this._hotkeys[e] = new n.GamepadButton(this.game, e)),
          this._hotkeys[e]
        );
      },
      pollStatus: function () {
    ...
    (n.BitmapData.prototype = {
      ...
      addTo: function (e) {
        for (var t = 0; t < e.length; t++)
          e[t].texture && e[t].loadTexture(this);
      },
      clear: function () {
        this.context.clearRect(0, 0, this.width, this.height),
          (this._dirty = !0);
      ...
      beginLinearGradientFill: function (e, t, n, r, i, s) {
        for (
          var o = this.createLinearGradient(n, r, i, s), u = 0, a = e.length;
          a > u;
          u++
        )
          o.addColorStop(t[u], e[u]);
      ...
      beginRadialGradientStroke: function (e, t, n, r, i, s, o, u) {
        for (
          var a = this.createRadialGradient(n, r, i, s, o, u),
            f = 0,
            l = e.length;
          l > f;
          f++
        )
          a.addColorStop(t[f], e[f]);
      ...
      bezierCurveTo: function (e, t, n, r, i, s) {
        return (
          (this._dirty = !0), this.context.bezierCurveTo(e, t, n, r, i, s), this
        );
      },
      ...
      ellipse: function (e, t, n, r) {
        ...
        return (
          this.moveTo(e, l),
          this.bezierCurveTo(e, l - o, f - s, t, f, t),
          this.bezierCurveTo(f + s, t, u, l - o, u, l),
          this.bezierCurveTo(u, l + o, f + s, a, f, a),
          this.bezierCurveTo(f - s, a, e, l + o, e, l),
          this
        );
      },
      fill: function () {
      ...
      quadraticCurveTo: function (e, t, n, r) {
        return (
          (this._dirty = !0), this.context.quadraticCurveTo(e, t, n, r), this
        );
      },
      ...
      render: function () {
        this._dirty &&
          (this.game.renderType == n.WEBGL &&
            t.texturesToUpdate.push(this.baseTexture),
          (this._dirty = !1));
      },
    }),
    ...
    (n.BitmapData.prototype.lf =
      n.BitmapData.prototype.beginLinearGradientFill),
    (n.BitmapData.prototype.rf =
      n.BitmapData.prototype.beginRadialGradientFill),
    ...
    (n.BitmapData.prototype.ls =
      n.BitmapData.prototype.beginLinearGradientStroke),
    (n.BitmapData.prototype.rs =
      n.BitmapData.prototype.beginRadialGradientStroke),
    ...
    (n.Sprite = function (e, r, i, s, o) {
      (r = r || 0),
        ...
        s instanceof n.RenderTexture
          ? (t.Sprite.call(this, s),
            (this.currentFrame = this.game.cache.getTextureFrame(s.name)))
          : s instanceof n.BitmapData
          ? (t.Sprite.call(this, s.texture, s.textureFrame),
            (this.currentFrame = s.textureFrame))
          : s instanceof t.Texture
          ? (t.Sprite.call(this, s), (this.currentFrame = o))
          : (null === s || "undefined" == typeof s
              ? ((s = "__default"), (this.key = s))
              : "string" == typeof s &&
                this.game.cache.checkImageKey(s) === !1 &&
                ((s = "__missing"), (this.key = s)),
            t.Sprite.call(this, t.TextureCache[s]),
            this.game.cache.isSpriteSheet(s)
              ? (this.animations.loadFrameData(this.game.cache.getFrameData(s)),
                null !== o &&
                  ("string" == typeof o
                    ? (this.frameName = o)
                    : (this.frame = o)))
              : (this.currentFrame = this.game.cache.getFrame(s))),
        (this.textureRegion = new n.Rectangle(
        ...
        (this.offset = new n.Point()),
        (this.center = new n.Point(
          r + Math.floor(this._cache.width / 2),
          i + Math.floor(this._cache.height / 2)
        )),
        (this.topLeft = new n.Point(r, i)),
        (this.topRight = new n.Point(r + this._cache.width, i)),
        (this.bottomRight = new n.Point(
          r + this._cache.width,
          i + this._cache.height
        )),
        ...
        (this.health = 1),
        (this.inWorld = n.Rectangle.intersects(
          this.bounds,
      ...
      return this._cache.fresh
        ? (this.world.setTo(
          ...
          void (
            this.body &&
            ((this.body.x =
              this.world.x - this.anchor.x * this.width + this.body.offset.x),
            (this.body.y =
              this.world.y - this.anchor.y * this.height + this.body.offset.y),
    ...
    (n.Sprite.prototype.updateBounds = function () {
      this.offset.setTo(
        ...
        (this._cache.left = n.Math.min(
          this.topLeft.x,
          this.topRight.x,
          this.bottomLeft.x,
          this.bottomRight.x
        )),
        (this._cache.right = n.Math.max(
          this.topLeft.x,
          this.topRight.x,
          this.bottomLeft.x,
          this.bottomRight.x
        )),
        (this._cache.top = n.Math.min(
          this.topLeft.y,
          this.topRight.y,
          this.bottomLeft.y,
          this.bottomRight.y
        )),
        (this._cache.bottom = n.Math.max(
          this.topLeft.y,
          this.topRight.y,
          this.bottomLeft.y,
          this.bottomRight.y
        ...
        (this._cache.cameraVisible = n.Rectangle.intersects(
    ...
    (n.Sprite.prototype.getLocalPosition = function (e, t, n) {
      return (
        (e.x =
          (this._cache.a11 * this._cache.id * t +
            -this._cache.a01 * this._cache.id * n +
          ...
          this._cache.a02),
        (e.y =
          (this._cache.a00 * this._cache.id * n +
            -this._cache.a10 * this._cache.id * t +
    ...
    (n.Sprite.prototype.getLocalUnmodifiedPosition = function (e, t, n) {
      return (
        (e.x =
          this._cache.a11 * this._cache.idi * t +
          -this._cache.i01 * this._cache.idi * n +
          (this._cache.a12 * this._cache.i01 -
            this._cache.a02 * this._cache.a11) *
            this._cache.idi +
          this.anchor.x * this._cache.width),
        (e.y =
          this._cache.a00 * this._cache.idi * n +
          -this._cache.i10 * this._cache.idi * t +
          (-this._cache.a12 * this._cache.a00 +
    ...
    (n.Sprite.prototype.loadTexture = function (e, r) {
      (this.key = e),
        e instanceof n.RenderTexture
          ...
          ? (this.currentFrame = r)
          : (("undefined" == typeof e ||
              this.game.cache.checkImageKey(e) === !1) &&
              ((e = "__default"), (this.key = e)),
              ...
              ? (this.animations.loadFrameData(this.game.cache.getFrameData(e)),
                "undefined" != typeof r &&
                  ("string" == typeof r
                    ? (this.frameName = r)
                    : (this.frame = r)))
              : ((this.currentFrame = this.game.cache.getFrame(e)),
                this.setTexture(t.TextureCache[e])));
    }),
    (n.Sprite.prototype.centerOn = function (e, t) {
      return (
        this.fixedToCamera
          ? ((this.cameraOffset.x = e + (this.cameraOffset.x - this.center.x)),
            (this.cameraOffset.y = t + (this.cameraOffset.y - this.center.y)))
          : ((this.x = e + (this.x - this.center.x)),
            (this.y = t + (this.y - this.center.y))),
        this
      );
    }),
    ...
    (n.Sprite.prototype.damage = function (e) {
      return (
        this.alive && ((this.health -= e), this.health < 0 && this.kill()), this
      );
    }),
    ...
    Object.defineProperty(n.Sprite.prototype, "width", {
      ...
      set: function (e) {
        (this.scale.x = e / this.currentFrame.width),
          (this._cache.scaleX = e / this.currentFrame.width),
          (this._width = e);
      },
    }),
    Object.defineProperty(n.Sprite.prototype, "height", {
      ...
      set: function (e) {
        (this.scale.y = e / this.currentFrame.height),
          (this._cache.scaleY = e / this.currentFrame.height),
          (this._height = e);
      },
    }),
    ...
    (n.TileSprite.prototype = n.Utils.extend(
      !0,
      t.TilingSprite.prototype,
      n.Sprite.prototype
    )),
    ...
    (n.Button.prototype = n.Utils.extend(
      !0,
      n.Button.prototype,
      n.Sprite.prototype,
      t.Sprite.prototype
    ...
    (n.Button.prototype.setOverSound = function (e, t) {
      (this.onOverSound = null),
        (this.onOverSoundMarker = ""),
        e instanceof n.Sound && (this.onOverSound = e),
        "string" == typeof t && (this.onOverSoundMarker = t);
    }),
    (n.Button.prototype.setOutSound = function (e, t) {
      (this.onOutSound = null),
        (this.onOutSoundMarker = ""),
        e instanceof n.Sound && (this.onOutSound = e),
        "string" == typeof t && (this.onOutSoundMarker = t);
    }),
    (n.Button.prototype.setDownSound = function (e, t) {
      (this.onDownSound = null),
        (this.onDownSoundMarker = ""),
        e instanceof n.Sound && (this.onDownSound = e),
        "string" == typeof t && (this.onDownSoundMarker = t);
    }),
    (n.Button.prototype.setUpSound = function (e, t) {
      (this.onUpSound = null),
        (this.onUpSoundMarker = ""),
        e instanceof n.Sound && (this.onUpSound = e),
        "string" == typeof t && (this.onUpSoundMarker = t);
    }),
    ...
    (n.Graphics = function (e, r, i) {
      (this.game = e),
        t.Graphics.call(this),
        (this.type = n.GRAPHICS),
        (this.position.x = r),
        (this.position.y = i);
    }),
    ...
    (n.RenderTexture.prototype.render = function (e, r, i, s) {
      "undefined" == typeof r && (r = !1),
        "undefined" == typeof i && (i = !1),
        "undefined" == typeof s && (s = !1),
        e instanceof n.Group && (e = e._container),
        t.gl ? this.renderWebGL(e, r, i, s) : this.renderCanvas(e, r, i, s);
    }),
    (n.RenderTexture.prototype.renderXY = function (e, t, n, r, i) {
      (this._tempPoint.x = t),
        (this._tempPoint.y = n),
        this.render(e, this._tempPoint, r, i);
    }),
    ...
    (n.RenderTexture.prototype.renderCanvas = function (e, n, r, i) {
      ...
      r && this.renderer.context.clearRect(0, 0, this.width, this.height),
        this.renderer.renderDisplayObject(e, i),
        this.renderer.context.setTransform(1, 0, 0, 1, 0, 0);
    }),
    (n.Canvas = {
    ...
    (n.StageScaleMode.prototype = {
      startFullScreen: function (e) {
        if (!this.isFullScreen) {
          "undefined" != typeof e &&
            n.Canvas.setSmoothingEnabled(this.game.context, e);
          ...
          (this._width = this.width),
            ...
            t.requestFullScreen
              ...
              ? t.parentNode.mozRequestFullScreen()
      ...
      checkOrientation: function (e) {
        (this.event = e),
          ...
          this.game.stage.scaleMode !== n.StageScaleMode.NO_SCALE &&
            this.refresh();
      },
        ...
        "undefined" == typeof e && (e = !1),
          ...
          (e ||
            ...
            this.incorrectOrientation === !0
              ...
              : this.isFullScreen
              ? this.game.stage.fullScreenScaleMode ==
                n.StageScaleMode.EXACT_FIT
                ? this.setExactFit()
                : this.game.stage.fullScreenScaleMode ==
                    n.StageScaleMode.SHOW_ALL && this.setShowAll()
              : this.game.stage.scaleMode == n.StageScaleMode.EXACT_FIT
              ? this.setExactFit()
              : this.game.stage.scaleMode == n.StageScaleMode.SHOW_ALL &&
                this.setShowAll(),
            this.setSize(),
    ...
    (n.RequestAnimationFrame = function (e) {
      ...
      for (
        ...
        (window.requestAnimationFrame = window[t[n] + "RequestAnimationFrame"]),
          (window.cancelAnimationFrame = window[t[n] + "CancelAnimationFrame"]);
    ...
    (n.Math = {
      ...
      max: function () {
        for (var e = 1, t = 0, n = arguments.length; n > e; e++)
          arguments[t] < arguments[e] && (t = e);
        return arguments[t];
      },
      min: function () {
    ...
    (n.QuadTree.prototype = {
      ...
      populateHandler: function (e) {
        e.body &&
          e.body.checkCollision.none === !1 &&
          e.alive &&
          this.insert(e.body);
      },
      split: function () {
        this.level++,
          (this.nodes[0] = new n.QuadTree(
            this.bounds.right,
            this.bounds.y,
      ...
      insert: function (e) {
        ...
        if (
          ...
          for (null == this.nodes[0] && this.split(); n < this.objects.length; )
      ...
      clear: function () {
        this.objects = [];
        for (var e = 0, t = this.nodes.length; t > e; e++)
          this.nodes[e] && (this.nodes[e].clear(), delete this.nodes[e]);
      },
    }),
    ...
    (n.Circle.prototype = {
      ...
      distance: function (e, t) {
        return (
          "undefined" == typeof t && (t = !1),
          t
            ? n.Math.distanceRound(this.x, this.y, e.x, e.y)
            : n.Math.distance(this.x, this.y, e.x, e.y)
        );
      },
      clone: function (e) {
        return (
          "undefined" == typeof e && (e = new n.Circle()),
    ...
    (n.Circle.circumferencePoint = function (e, t, r, i) {
      return (
        ...
        r === !0 && (t = n.Math.radToDeg(t)),
        (i.x = e.x + e.radius * Math.cos(t)),
        (i.y = e.y + e.radius * Math.sin(t)),
        i
      );
    }),
    ...
    (n.Point.prototype = {
      ...
      clamp: function (e, t) {
        return (
          (this.x = n.Math.clamp(this.x, e, t)),
          (this.y = n.Math.clamp(this.y, e, t)),
          this
        );
      },
      clone: function (e) {
    ...
    (n.Point.add = function (e, t, r) {
      return (
        "undefined" == typeof r && (r = new n.Point()),
        (r.x = e.x + t.x),
        (r.y = e.y + t.y),
        r
      );
    ...
    (n.Point.distance = function (e, t, r) {
      return (
        "undefined" == typeof r && (r = !1),
        r
          ? n.Math.distanceRound(e.x, e.y, t.x, t.y)
          : n.Math.distance(e.x, e.y, t.x, t.y)
      );
    }),
    (n.Point.rotate = function (e, t, r, i, s, o) {
      return (
        (s = s || !1),
        (o = o || null),
        s && (i = n.Math.degToRad(i)),
        null === o &&
          (o = Math.sqrt((t - e.x) * (t - e.x) + (r - e.y) * (r - e.y))),
        e.setTo(t + o * Math.cos(i), r + o * Math.sin(i))
      );
    }),
    ...
    (n.Rectangle.prototype = {
      ...
      setTo: function (e, t, n, r) {
        return (
          (this.x = e), (this.y = t), (this.width = n), (this.height = r), this
        );
      },
      floor: function () {
    ...
    (n.Rectangle.size = function (e, t) {
      return (
        "undefined" == typeof t && (t = new n.Point()),
        t.setTo(e.width, e.height)
      );
    }),
    (n.Rectangle.clone = function (e, t) {
      return (
        "undefined" == typeof t && (t = new n.Rectangle()),
        t.setTo(e.x, e.y, e.width, e.height)
      );
    }),
    ...
    (n.Rectangle.intersection = function (e, t, r) {
      return (
        (r = r || new n.Rectangle()),
        n.Rectangle.intersects(e, t) &&
          ((r.x = Math.max(e.x, t.x)),
          (r.y = Math.max(e.y, t.y)),
          (r.width = Math.min(e.right, t.right) - r.x),
          (r.height = Math.min(e.bottom, t.bottom) - r.y)),
        r
      );
    }),
    (n.Rectangle.intersects = function (e, t) {
      return e.width <= 0 || e.height <= 0 || t.width <= 0 || t.height <= 0
        ? !1
        : !(e.right < t.x || e.bottom < t.y || e.x > t.right || e.y > t.bottom);
    }),
    ...
    (n.Rectangle.union = function (e, t, r) {
      return (
        "undefined" == typeof r && (r = new n.Rectangle()),
        r.setTo(
          Math.min(e.x, t.x),
          Math.min(e.y, t.y),
          Math.max(e.right, t.right) - Math.min(e.left, t.left),
          Math.max(e.bottom, t.bottom) - Math.min(e.top, t.top)
        )
      );
    }),
    ...
    (n.Easing = {
        ...
        Out: function (e) {
          ...
          return 0 === e
            ...
            : (!n || 1 > n
                ? ((n = 1), (t = r / 4))
                : (t = (r * Math.asin(1 / n)) / (2 * Math.PI)),
              n * Math.pow(2, -10 * e) * Math.sin((2 * (e - t) * Math.PI) / r) +
                1);
        },
        InOut: function (e) {
          var t,
      ...
      Bounce: {
        ...
        InOut: function (e) {
          return 0.5 > e
            ? 0.5 * n.Easing.Bounce.In(2 * e)
            : 0.5 * n.Easing.Bounce.Out(2 * e - 1) + 0.5;
        },
      },
    }),
    (n.Time = function (e) {
    ...
    (n.Timer.prototype = {
      ...
      remove: function (e) {
        for (var t = 0; t < this.events.length; t++)
          if (this.events[t] === e) return this.events.splice(t, 1), !0;
        return !1;
      },
      order: function () {
      ...
      resume: function () {
        for (
          var e = this.game.time.now - this._pauseStarted, t = 0;
      ...
      add: function (e, r, i, s, o) {
        return null == this._frameData
          ...
          : ((i = i || 60),
            "undefined" == typeof s && (s = !1),
            "undefined" == typeof o &&
              (o = r && "number" == typeof r[0] ? !0 : !1),
            null == this.sprite.events.onAnimationStart &&
              ((this.sprite.events.onAnimationStart = new n.Signal()),
              (this.sprite.events.onAnimationComplete = new n.Signal()),
              (this.sprite.events.onAnimationLoop = new n.Signal())),
            (this._outputFrames.length = 0),
            this._frameData.getFrameIndexes(r, o, this._outputFrames),
            (this._anims[e] = new n.Animation(
              this.game,
              this.sprite,
              e,
              this._frameData,
                ...
                ? ((this._frameIndex %= this._frames.length),
                  ...
                  this.currentFrame &&
                    this._parent.setTexture(
                      t.TextureCache[this.currentFrame.uuid]
                    ),
    ...
    (n.FrameData.prototype = {
      ...
      getFrames: function (e, t, n) {
        if (
          ...
          for (var r = 0; r < this._frames.length; r++) n.push(this._frames[r]);
        else
    ...
    (n.AnimationParser = {
      spriteSheet: function (e, r, i, s, o, u, a) {
        ...
        0 >= i && (i = Math.floor(-l / Math.min(-1, i))),
          0 >= s && (s = Math.floor(-c / Math.min(-1, s)));
        var h = Math.round(l / i),
          p = Math.round(c / s),
          d = h * p;
        if (
          (-1 !== o && (d = o), 0 === l || 0 === c || i > l || s > c || 0 === d)
        )
          return (
            console.warn(
        ...
        for (var v = new n.FrameData(), m = u, g = u, y = 0; d > y; y++) {
          var b = e.rnd.uuid();
          v.addFrame(new n.Frame(y, m, g, i, s, "", b)),
            (t.TextureCache[b] = new t.Texture(t.BaseTextureCache[r], {
              x: m,
              y: g,
              width: i,
              height: s,
      ...
      JSONData: function (e, r, i) {
        ...
        for (
          var s, o = new n.FrameData(), u = r.frames, a = 0;
          a < u.length;
          a++
        ) {
          var f = e.rnd.uuid();
          (s = o.addFrame(
            ...
            (t.TextureCache[f] = new t.Texture(t.BaseTextureCache[i], {
              x: u[a].frame.x,
              y: u[a].frame.y,
              width: u[a].frame.w,
              height: u[a].frame.h,
            ...
            u[a].trimmed &&
              (s.setTrim(
                ...
                u[a].sourceSize.w,
                u[a].sourceSize.h,
                u[a].spriteSourceSize.x,
                u[a].spriteSourceSize.y,
                u[a].spriteSourceSize.w,
                u[a].spriteSourceSize.h
              ),
      ...
      JSONDataHash: function (e, r, i) {
        ...
        for (var f in u) {
          ...
          (s = o.addFrame(
            ...
            (t.TextureCache[l] = new t.Texture(t.BaseTextureCache[i], {
              x: u[f].frame.x,
              y: u[f].frame.y,
              width: u[f].frame.w,
              height: u[f].frame.h,
            ...
            u[f].trimmed &&
              (s.setTrim(
                ...
                u[f].sourceSize.w,
                u[f].sourceSize.h,
                u[f].spriteSourceSize.x,
                u[f].spriteSourceSize.y,
                u[f].spriteSourceSize.w,
                u[f].spriteSourceSize.h
              ),
      ...
      XMLData: function (e, r, i) {
        ...
        for (
          var s,
            ...
            m,
            g = new n.FrameData(),
            y = r.getElementsByTagName("SubTexture"),
            b = 0;
          b < y.length;
          b++
        )
          (o = e.rnd.uuid()),
            ...
            (d = null),
            a.frameX &&
              ((p = Math.abs(parseInt(a.frameX.nodeValue, 10))),
              (d = Math.abs(parseInt(a.frameY.nodeValue, 10))),
              (v = parseInt(a.frameWidth.nodeValue, 10)),
              (m = parseInt(a.frameHeight.nodeValue, 10))),
            (s = g.addFrame(new n.Frame(b, f, l, c, h, u, o))),
            (t.TextureCache[o] = new t.Texture(t.BaseTextureCache[i], {
              x: f,
              y: l,
              width: c,
              height: h,
            ...
            (null !== p || null !== d) &&
              (s.setTrim(!0, c, h, p, d, v, m),
              (t.TextureCache[o].realSize = {
                x: p,
                y: d,
                w: v,
                h: m,
              }),
              (t.TextureCache[o].trimmed = !0),
              (t.TextureCache[o].trim.x = p),
              (t.TextureCache[o].trim.y = d));
        return g;
      },
    }),
    (n.Cache = function (e) {
    ...
    (n.Cache.prototype = {
      ...
      addSpriteSheet: function (e, r, i, s, o, u, a, f) {
        (this._images[e] = {
          ...
          (this._images[e].frameData = n.AnimationParser.spriteSheet(
            this.game,
            e,
            s,
            o,
      ...
      addTextureAtlas: function (e, r, i, s, o) {
        (this._images[e] = {
          ...
          o == n.Loader.TEXTURE_ATLAS_JSON_ARRAY
            ? (this._images[e].frameData = n.AnimationParser.JSONData(
                this.game,
                s,
                e
              ))
            : o == n.Loader.TEXTURE_ATLAS_JSON_HASH
            ? (this._images[e].frameData = n.AnimationParser.JSONDataHash(
                this.game,
                s,
                e
              ))
            : o == n.Loader.TEXTURE_ATLAS_XML_STARLING &&
              (this._images[e].frameData = n.AnimationParser.XMLData(
                this.game,
                s,
                e
              ));
      ...
      addBitmapFont: function (e, r, i, s) {
        (this._images[e] = {
          ...
          (t.BaseTextureCache[e] = new t.BaseTexture(i)),
          (t.TextureCache[e] = new t.Texture(t.BaseTextureCache[e])),
          n.LoaderParser.bitmapFont(this.game, s, e);
      },
      addDefaultImage: function () {
        ...
        (e.src =
          ...
          (t.TextureCache.__default = new t.Texture(
            t.BaseTextureCache.__default
          ));
      },
      addMissingImage: function () {
        ...
        (e.src =
          ...
          (t.TextureCache.__missing = new t.Texture(
            t.BaseTextureCache.__missing
          ));
      },
      ...
      addImage: function (e, r, i) {
        (this._images[e] = {
          ...
          (this._images[e].frame = new n.Frame(
            0,
            0,
            0,
            i.width,
      ...
      getText: function (e) {
        return this._text[e]
          ? this._text[e].data
          : void console.warn('Phaser.Cache.getText: Invalid key: "' + e + '"');
      },
    ...
    (n.Loader.prototype = {
      setPreloadSprite: function (e, t) {
        (t = t || 0),
          ...
          (this.preloadSprite.crop =
            0 === t
              ? new n.Rectangle(0, 0, 1, e.height)
              : new n.Rectangle(0, 0, e.width, 1)),
      ...
      tilemap: function (e, t, r, i) {
        if (
          ...
          "undefined" == typeof i && (i = n.Tilemap.CSV),
          null == t && null == r)
        )
          return (
            console.warn(
      ...
      atlas: function (e, t, r, i, s) {
        if (
          ("undefined" == typeof r && (r = null),
          "undefined" == typeof i && (i = null),
          "undefined" == typeof s && (s = n.Loader.TEXTURE_ATLAS_JSON_ARRAY),
          r)
        )
        ...
        switch (e.type) {
                    ...
                    (this.game.sound.touchLocked
                      ...
                      : ((e.data = new Audio()),
                        ...
                        e.data.addEventListener(
                          "canplaythrough",
                          n.GAMES[this.game.id].load.fileComplete(
                            this._fileIndex
                          ),
                          !1
                        ),
          ...
          case "tilemap":
            if (
              ...
              e.format === n.Tilemap.TILED_JSON)
            )
              this._xhr.onload = function () {
                return t.jsonLoadComplete(t._fileIndex);
              };
            else {
              if (e.format !== n.Tilemap.CSV)
                throw new Error(
        ...
        switch (t.type) {
          ...
          case "textureatlas":
            if (null == t.atlasURL)
              ...
              if (
                ((r = !1),
                this._xhr.open("GET", this.baseURL + t.atlasURL, !0),
                (this._xhr.responseType = "text"),
                t.format == n.Loader.TEXTURE_ATLAS_JSON_ARRAY ||
                  t.format == n.Loader.TEXTURE_ATLAS_JSON_HASH)
              )
                this._xhr.onload = function () {
                  return i.jsonLoadComplete(e);
                };
              else {
                if (t.format != n.Loader.TEXTURE_ATLAS_XML_STARLING)
                  throw new Error(
                    "Phaser.Loader. Invalid Texture Atlas format: " + t.format
                  );
                this._xhr.onload = function () {
          ...
          case "audio":
            if (this.game.sound.usingWebAudio) {
              if (
                ((t.data = this._xhr.response),
                this.game.cache.addSound(t.key, t.url, t.data, !0, !1),
                t.autoDecode)
              ) {
              ...
              t.data.removeEventListener(
                "canplaythrough",
                n.GAMES[this.game.id].load.fileComplete
              ),
                this.game.cache.addSound(t.key, t.url, t.data, !1, !0);
            break;
          case "text":
            (t.data = this._xhr.responseText),
              this.game.cache.addText(t.key, t.url, t.data);
            break;
          case "script":
            (t.data = document.createElement("script")),
              ...
              (t.data.defer = !1),
              (t.data.text = this._xhr.responseText),
              document.head.appendChild(t.data);
            break;
          case "binary":
            (t.data = t.callback
              ? t.callback.call(t.callbackContext, t.key, this._xhr.response)
              : this._xhr.response),
              this.game.cache.addBinary(t.key, t.data);
        }
        r && this.nextFile(e, !0);
      },
      ...
      xmlLoadComplete: function (e) {
        ...
        (s.loaded = !0),
          "bitmapfont" == s.type
            ? this.game.cache.addBitmapFont(s.key, s.url, s.data, t)
            : "textureatlas" == s.type &&
              this.game.cache.addTextureAtlas(
                s.key,
                s.url,
    ...
    (n.LoaderParser = {
      bitmapFont: function (e, n, r) {
        ...
        (s.font = o.attributes.getNamedItem("face").nodeValue),
          (s.size = parseInt(o.attributes.getNamedItem("size").nodeValue, 10)),
          (s.lineHeight = parseInt(
            u.attributes.getNamedItem("lineHeight").nodeValue,
            10
          )),
          (s.chars = {});
        for (var a = n.getElementsByTagName("char"), f = 0; f < a.length; f++) {
          var l = parseInt(a[f].attributes.getNamedItem("id").nodeValue, 10),
            c = {
              ...
              width: parseInt(
                a[f].attributes.getNamedItem("width").nodeValue,
                10
              ),
              height: parseInt(
                a[f].attributes.getNamedItem("height").nodeValue,
                10
              ),
            };
          (t.TextureCache[l] = new t.Texture(i, c)),
            (s.chars[l] = {
              xOffset: parseInt(
                a[f].attributes.getNamedItem("xoffset").nodeValue,
                10
              ),
              yOffset: parseInt(
                a[f].attributes.getNamedItem("yoffset").nodeValue,
                10
              ),
              xAdvance: parseInt(
                a[f].attributes.getNamedItem("xadvance").nodeValue,
                10
              ),
              kerning: {},
    ...
    (n.Sound = function (e, t, r, i, s) {
      "undefined" == typeof r && (r = 1),
        ...
        this.usingWebAudio
          ...
          ? ((this._sound = this.game.cache.getSoundData(t)),
            (this.totalDuration = 0),
    ...
    Object.defineProperty(n.SoundManager.prototype, "volume", {
      ...
      set: function (e) {
        (e = this.game.math.clamp(e, 1, 0)),
          (this._volume = e),
          this.usingWebAudio && (this.masterGain.gain.value = e);
        for (var t = 0; t < this._sounds.length; t++)
    ...
    (n.Utils.Debug.prototype = {
      ...
      line: function (e, t, n) {
        null != this.context &&
          ...
          this.renderShadow &&
            ...
            this.context.fillText(e, this.currentX + 1, this.currentY + 1),
      ...
      renderSpriteCorners: function (e, t, n, r) {
        null != this.context &&
          ...
          t &&
            ...
            this.line(
              "x: " +
                Math.floor(e.topLeft.x) +
                " y: " +
                Math.floor(e.topLeft.y),
              e.topLeft.x,
              e.topLeft.y
            ),
            this.line(
              "x: " +
                Math.floor(e.topRight.x) +
                " y: " +
                Math.floor(e.topRight.y),
              e.topRight.x,
              e.topRight.y
            ),
            this.line(
              "x: " +
                Math.floor(e.bottomLeft.x) +
                " y: " +
                Math.floor(e.bottomLeft.y),
              e.bottomLeft.x,
              e.bottomLeft.y
            ),
            this.line(
              "x: " +
                Math.floor(e.bottomRight.x) +
                " y: " +
                Math.floor(e.bottomRight.y),
              e.bottomRight.x,
              e.bottomRight.y
            )),
          this.stop());
      ...
      renderBodyInfo: function (e, t, n, r) {
        (r = r || "rgb(255,255,255)"),
          ...
          this.splitline(
            "x: " + e.body.x.toFixed(2),
            "y: " + e.body.y.toFixed(2),
            "width: " + e.width,
            "height: " + e.height
          ),
          this.splitline(
            "speed: " + e.body.speed.toFixed(2),
            "angle: " + e.body.angle.toFixed(2),
            "linear damping: " + e.body.linearDamping
          ),
          this.splitline(
            "blocked left: " + e.body.blocked.left,
            "right: " + e.body.blocked.right,
            "up: " + e.body.blocked.up,
            "down: " + e.body.blocked.down
          ),
          this.splitline(
            "touching left: " + e.body.touching.left,
            "right: " + e.body.touching.right,
            "up: " + e.body.touching.up,
            "down: " + e.body.touching.down
          ),
          this.splitline(
            "gravity x: " + e.body.gravity.x,
            "y: " + e.body.gravity.y,
            "world gravity x: " + this.game.physics.gravity.x,
            "y: " + this.game.physics.gravity.y
          ),
          this.splitline(
            "acceleration x: " + e.body.acceleration.x.toFixed(2),
            "y: " + e.body.acceleration.y.toFixed(2)
          ),
          this.splitline(
            "velocity x: " + e.body.velocity.x.toFixed(2),
            "y: " + e.body.velocity.y.toFixed(2),
            "deltaX: " + e.body.deltaX().toFixed(2),
            "deltaY: " + e.body.deltaY().toFixed(2)
          ),
          this.splitline(
            "bounce x: " + e.body.bounce.x.toFixed(2),
            "y: " + e.body.bounce.y.toFixed(2)
          ),
          this.stop();
      },
      ...
      renderSpriteInfo: function (e, t, n, r) {
        null != this.context &&
          ...
          this.line(
            "body x: " + e.body.x.toFixed(1) + " y: " + e.body.y.toFixed(1)
          ),
          this.line("id: " + e._id),
      ...
      renderPointInfo: function (e, t, n, r) {
        null != this.context &&
          ((r = r || "rgb(255, 255, 255)"),
          this.start(t, n, r),
          this.line("px: " + e.x.toFixed(1) + " py: " + e.y.toFixed(1)),
          this.stop());
      },
      ...
      renderPoint: function (e, t) {
        null != this.context &&
          ...
          this.start(),
          (this.context.fillStyle = t),
          this.context.fillRect(e.x, e.y, 4, 4),
          this.stop());
      },
      renderRectangle: function (e, t) {
        null != this.context &&
          ((t = t || "rgba(0,255,0,0.3)"),
          this.start(),
          (this.context.fillStyle = t),
      ...
      renderCircle: function (e, t) {
        null != this.context &&
          ...
          this.context.beginPath(),
          (this.context.fillStyle = t),
          this.context.arc(e.x, e.y, e.radius, 0, 2 * Math.PI, !1),
          this.context.fill(),
          this.context.closePath(),
          this.stop());
      },
        ...
        if (null !== this.context || null !== r) {
          ...
          if (e.type === n.Physics.Arcade.CIRCLE)
            this.start(0, 0, t),
              this.context.beginPath(),
              (this.context.strokeStyle = t),
              this.context.arc(i, s, e.shape.r, 0, 2 * Math.PI, !1),
              this.context.stroke(),
              this.context.closePath(),
              this.stop();
          else {
            ...
            this.start(0, 0, t),
              this.context.beginPath(),
              this.context.moveTo(i + o[0].x, s + o[0].y);
            for (var u = 1; u < o.length; u++)
              this.context.lineTo(i + o[u].x, s + o[u].y);
            this.context.closePath(),
              (this.context.strokeStyle = t),
              this.context.stroke(),
              (this.context.fillStyle = "rgb(255,0,0)"),
              this.context.fillRect(i + o[0].x - 2, s + o[0].y - 2, 5, 5);
            for (var u = 1; u < o.length; u++)
              (this.context.fillStyle = "rgb(255," + 40 * u + ",0)"),
                this.context.fillRect(i + o[u].x - 2, s + o[u].y - 2, 5, 5);
            this.stop();
          }
        }
      },
      renderPolygon: function (e, t, n) {
        if (null !== this.context || null !== n) {
          ...
          this.start(0, 0, t),
            this.context.beginPath(),
            this.context.moveTo(i + r[0].x, s + r[0].y);
          for (var o = 1; o < r.length; o++)
            this.context.lineTo(i + r[o].x, s + r[o].y);
          this.context.closePath(),
            (this.context.strokeStyle = t),
            this.context.stroke(),
            this.stop();
    ...
    (n.Color = {
      ...
      RGBtoHexstring: function (e) {
        ...
        return (
          "0x" +
          n.Color.colorToHexstring(t.alpha) +
          n.Color.colorToHexstring(t.red) +
          n.Color.colorToHexstring(t.green) +
          n.Color.colorToHexstring(t.blue)
        );
      },
      ...
      getRandomColor: function (e, t, r) {
        if (
          ("undefined" == typeof e && (e = 0),
          "undefined" == typeof t && (t = 255),
          "undefined" == typeof r && (r = 255),
          t > 255)
        )
          return n.Color.getColor(255, 255, 255);
    ...
    (function (e, t) {
      ...
      function s(e, t, n) {
        for (
          var r = Number.MAX_VALUE, i = -Number.MAX_VALUE, s = e.length, o = 0;
          s > o;
          o++
        ) {
          var u = e[o].dot(t);
      ...
      function o(e, t, n, r, i, o) {
        ...
        if (
          ...
          return p.push(f), v.push(u), v.push(a), !0;
        if (o) {
          var c = 0;
          if (u[0] < a[0])
      ...
      function a(e, t, n) {
        ...
        if (n) {
          ...
          (n.a = e),
            ...
            (n.aInB = e.r <= t.r && u <= t.r - e.r),
            (n.bInA = t.r <= e.r && u <= e.r - t.r);
        }
        return p.push(r), !0;
      }
      ...
      function f(e, t, n) {
        for (
          ...
          if (b === m) {
            ...
            if (
              (f.copy(e.edges[h]), l.copy(r).sub(o[h]), (b = u(f, l)), b === m)
            ) {
              var E = l.len();
          ...
          g &&
            n &&
            Math.abs(v) < Math.abs(n.overlap) &&
            ((n.overlap = v), n.overlapN.copy(g));
        }
        return (
          n &&
            ((n.a = e),
      ...
      function c(e, t, n) {
        for (
          var r = e.points, i = r.length, s = t.points, u = s.length, a = 0;
          i > a;
          a++
        )
          if (o(e.pos, t.pos, r, s, e.normals[a], n)) return !1;
        for (var a = 0; u > a; a++)
          if (o(e.pos, t.pos, r, s, t.normals[a], n)) return !1;
        return (
          n &&
            ((n.a = e),
            (n.b = t),
      ...
      (h.Vector = e),
        ...
        (e.prototype.normalize = e.prototype.normalize =
          function () {
            var e = this.len();
            return (
              e > 0 && ((this.x = this.x / e), (this.y = this.y / e)), this
            );
          }),
        ...
        (e.prototype.reflectN = e.prototype.reflectN =
          function (e) {
            var t = this.x,
              n = this.y;
            return (
              this.projectN(e).scale(2), (this.x -= t), (this.y -= n), this
            );
          }),
        ...
        (n.prototype.rotate = n.prototype.rotate =
          function (e) {
            var t,
              ...
              u = Math.sin(e);
            for (t = 0; s > t; t++)
              n[t].rotatePrecalc(u, o),
                r[t].rotatePrecalc(u, o),
                i[t].rotatePrecalc(u, o);
            return this;
          }),
        (n.prototype.scale = n.prototype.scale =
          function (e, t) {
            var n,
              ...
              o = r.length;
            for (n = 0; o > n; n++)
              r[n].scale(e, t), i[n].scale(e, t), s[n].scale(e, t);
            return this;
          }),
      ...
      var m = -1,
        ...
        y = 1;
      return (
        (h.testCircleCircle = a),
        (h.testPolygonCircle = f),
        (h.testCirclePolygon = l),
        (h.testPolygonPolygon = c),
        h
      );
    }),
    (n.Physics = {}),
    ...
    (n.Physics.Arcade.prototype = {
      checkBounds: function (e) {
        ...
        var t = SAT.testPolygonPolygon,
          ...
          i = !1;
        return (
          e.type === n.Physics.Arcade.CIRCLE &&
            ((t = SAT.testPolygonCircle), (r = e.shape)),
          this.worldLeft && t(this.worldPolys[0], r, this._response)
            ? ((e.blocked.left = !0),
              r.pos.add(this._response.overlapV),
              (e.blocked.x = Math.floor(e.x)),
              (e.blocked.y = Math.floor(e.y)),
              (i = !0))
            : this.worldRight &&
              t(this.worldPolys[1], r, this._response) &&
              ((e.blocked.right = !0),
              r.pos.add(this._response.overlapV),
              (e.blocked.x = Math.floor(e.x)),
              (e.blocked.y = Math.floor(e.y)),
          ...
          this.worldTop && t(this.worldPolys[2], r, this._response)
            ? ((e.blocked.up = !0),
              ...
              (i = !0))
            : this.worldBottom &&
              t(this.worldPolys[3], r, this._response) &&
              ((e.blocked.down = !0),
              r.pos.add(this._response.overlapV),
              (e.blocked.x = Math.floor(e.x)),
              (e.blocked.y = Math.floor(e.y)),
      ...
      updateMotion: function (e) {
        return (
          e.allowGravity
            ? ((this._gravityX = this.gravity.x + e.gravity.x),
              (this._gravityY = this.gravity.y + e.gravity.y))
            : ((this._gravityX = e.gravity.x), (this._gravityY = e.gravity.y)),
          ((this._gravityX < 0 && e.blocked.left) ||
            (this._gravityX > 0 && e.blocked.right)) &&
            (this._gravityX = 0),
          ((this._gravityY < 0 && e.blocked.up) ||
            (this._gravityY > 0 && e.blocked.down)) &&
            (this._gravityY = 0),
          e.allowRotation &&
            ((this._velocityDelta =
              e.angularAcceleration * this.game.time.physicsElapsed),
            0 !== e.angularDrag &&
              0 === e.angularAcceleration &&
              ((this._drag = e.angularDrag * this.game.time.physicsElapsed),
              e.angularVelocity > 0
                ? (e.angularVelocity -= this._drag)
                : e.angularVelocity < 0 && (e.angularVelocity += this._drag)),
            (e.rotation +=
              this.game.time.physicsElapsed *
              (e.angularVelocity + this._velocityDelta / 2)),
            (e.angularVelocity += this._velocityDelta),
            e.angularVelocity > e.maxAngular
              ? (e.angularVelocity = e.maxAngular)
              : e.angularVelocity < -e.maxAngular &&
                (e.angularVelocity = -e.maxAngular)),
          this._p.setTo(
            (e.acceleration.x + this._gravityX) * this.game.time.physicsElapsed,
            (e.acceleration.y + this._gravityY) * this.game.time.physicsElapsed
          ),
          this._p
        );
      },
      ...
      collideHandler: function (e, t, r, i, s, o) {
        return "undefined" != typeof t ||
          (e.type !== n.GROUP && e.type !== n.EMITTER)
          ? void (
              e &&
              t &&
              e.exists &&
              ...
              (e.type == n.SPRITE || e.type == n.TILESPRITE
                ? t.type == n.SPRITE || t.type == n.TILESPRITE
                  ...
                  : t.type == n.TILEMAPLAYER &&
                    this.collideSpriteVsTilemapLayer(e, t, r, i, s)
                : e.type == n.GROUP
                ? t.type == n.SPRITE || t.type == n.TILESPRITE
                  ...
                  : t.type == n.TILEMAPLAYER &&
                    this.collideGroupVsTilemapLayer(e, t, r, i, s)
                : e.type == n.TILEMAPLAYER
                ? t.type == n.SPRITE || t.type == n.TILESPRITE
                  ? this.collideSpriteVsTilemapLayer(t, e, r, i, s)
                  : (t.type == n.GROUP || t.type == n.EMITTER) &&
                    this.collideGroupVsTilemapLayer(t, e, r, i, s)
                : e.type == n.EMITTER &&
                  (t.type == n.SPRITE || t.type == n.TILESPRITE
                    ? this.collideSpriteVsGroup(t, e, r, i, s, o)
                    : t.type == n.GROUP || t.type == n.EMITTER
      ...
      collideSpriteVsGroup: function (e, t, r, i, s, o) {
        if (0 !== t.length) {
          ...
          for (var u = 0, a = this._potentials.length; a > u; u++)
            this.separate(e.body, this._potentials[u], i, s, o) &&
              (r && r.call(s, e, this._potentials[u].sprite), this._total++);
        }
      },
      collideGroupVsSelf: function (e, t, n, r, i) {
        if (0 !== e.length)
          for (var s = e._container.children.length, o = 0; s > o; o++)
            for (var u = o + 1; s >= u; u++)
              e._container.children[o] &&
                e._container.children[u] &&
                e._container.children[o].exists &&
                e._container.children[u].exists &&
      ...
      collideGroupVsGroup: function (e, t, n, r, i, s) {
        if (0 !== e.length && 0 !== t.length && e._container.first._iNext) {
          ...
          do
            o.exists && this.collideSpriteVsGroup(o, t, n, r, i, s),
              (o = o._iNext);
      ...
      collideSpriteVsTilemapLayer: function (e, t, n, r, i) {
        if (
          ...
          if (this._mapData.length > 1)
            this.separateTiles(e.body, this._mapData);
          else {
            var s = 0;
            this.separateTile(e.body, this._mapData[s]) &&
              (r
      ...
      collideGroupVsTilemapLayer: function (e, t, n, r, i) {
        if (0 !== e.length && e._container.first._iNext) {
          ...
          do
            s.exists && this.collideSpriteVsTilemapLayer(s, t, n, r, i),
              (s = s._iNext);
          while (s != e._container.last._iNext);
        }
      },
      separate: function (e, t, n, r, i) {
        return e === t || this.intersects(e, t) === !1
          ? !1
          : n && n.call(r, e.sprite, t.sprite) === !1
          ? !1
          : (this._response.clear(),
            i
              ? e.overlap(t, this._response)
              : e.overlap(t, this._response)
              ? e.separate(t, this._response)
              : !1);
      },
      intersects: function (e, t) {
        var n = !1;
        (e.width <= 0 || e.height <= 0 || t.width <= 0 || t.height <= 0) &&
          (n = !1),
          (n = !(
            e.right < t.left ||
            e.bottom < t.top ||
          ...
          !n && e.inContact(t) && e.removeContact(t);
      },
        ...
        return e.width <= 0 || e.height <= 0 || t.width <= 0 || t.height <= 0
          ...
          : ((this._intersection[0] = Math.max(e.left, t.x)),
            ...
            (this._intersection[2] =
              Math.min(e.right, t.right) - this._intersection[0]),
            (this._intersection[3] =
              Math.min(e.bottom, t.bottom) - this._intersection[1]),
            (this._intersection[4] = 1),
            this._intersection);
      },
      separateTiles: function (e, t) {
        for (var n, r = !1, i = 0; i < t.length; i++)
          (n = t[i]), this.separateTile(e, n) && (r = !0);
        return r;
      },
      separateTile: function (e, t) {
        if (
          ((this._intersection = this.tileIntersects(e, t)),
        ...
        if (t.tile.callback || t.layer.callbacks[t.tile.index]) {
          if (
            t.tile.callback &&
            t.tile.callback.call(t.tile.callbackContext, e.sprite, t) === !1
          )
            return !1;
          if (
            t.layer.callbacks[t.tile.index] &&
            t.layer.callbacks[t.tile.index].callback.call(
              t.layer.callbacks[t.tile.index].callbackContext,
              e.sprite,
              t
            ) === !1
          )
        ...
        return (
          ...
          t.tile.faceRight &&
          !e.blocked.left
            ? ((e.overlapX = e.left - t.right),
              e.overlapX < 0 ? (n = !0) : (e.overlapX = 0))
            : e.deltaX() > 0 &&
              e.checkCollision.right &&
              t.tile.faceLeft &&
              !e.blocked.right &&
              ((e.overlapX = e.right - t.x),
              e.overlapX > 0 ? (n = !0) : (e.overlapX = 0)),
          e.deltaY() < 0 &&
          e.checkCollision.up &&
          t.tile.faceBottom &&
          !e.blocked.up
            ? ((e.overlapY = e.top - t.bottom),
              e.overlapY < 0 ? (n = !0) : (e.overlapY = 0))
            : e.deltaY() > 0 &&
              e.checkCollision.down &&
              t.tile.faceTop &&
              !e.blocked.down &&
              ((e.overlapY = e.bottom - t.y),
              e.overlapY > 0 ? (n = !0) : (e.overlapY = 0)),
          0 !== e.overlapX &&
            0 !== e.overlapY &&
            (Math.abs(e.overlapX) > Math.abs(e.overlapY)
              ? (e.overlapX = 0)
              : (e.overlapY = 0)),
      ...
      velocityFromAngle: function (e, t, r) {
        return (
          ...
          (r = r || new n.Point()),
          r.setTo(
            Math.cos(this.game.math.degToRad(e)) * t,
            Math.sin(this.game.math.degToRad(e)) * t
          )
        );
      },
      velocityFromRotation: function (e, t, r) {
        return (
          "undefined" == typeof t && (t = 60),
          (r = r || new n.Point()),
          r.setTo(Math.cos(e) * t, Math.sin(e) * t)
        );
      },
    ...
    (n.Physics.Arcade.Body.prototype = {
      ...
      updateBounds: function () {
        this.type === n.Physics.Arcade.CIRCLE
          ...
          : ((this.left =
              n.Math.minProperty("x", this.polygon.points) +
              this.polygon.pos.x),
            (this.right =
              n.Math.maxProperty("x", this.polygon.points) +
              this.polygon.pos.x),
            (this.top =
              n.Math.minProperty("y", this.polygon.points) +
              this.polygon.pos.y),
            (this.bottom =
              n.Math.maxProperty("y", this.polygon.points) +
              this.polygon.pos.y)),
      ...
      reboundCheck: function (e, t, n) {
        if (
          ...
          (((this.blocked.left || this.touching.left) &&
            (0 > r || this.velocity.x < 0)) ||
            ((this.blocked.right || this.touching.right) &&
              (r > 0 || this.velocity.x > 0))) &&
            (this.velocity.x = 0);
        }
        if (
          t &&
          ...
          (((this.blocked.up || this.touching.up) &&
            (0 > i || this.velocity.y < 0)) ||
            ((this.blocked.down || this.touching.down) &&
              (i > 0 || this.velocity.y > 0))) &&
            (this.velocity.y = 0);
        }
      },
      ...
      give: function (e, t) {
        this.add(t.overlapV),
          this.rebound &&
            (this.processRebound(e),
            this.reboundCheck(!0, !0, !1),
            e.reboundCheck(!0, !0, !1));
      },
      take: function (e, t) {
        this.sub(t.overlapV),
          this.rebound &&
      ...
      exchange: function (e) {
        if (this.mass === e.mass && this.speed > 0 && e.speed > 0)
          ...
          var t =
              Math.sqrt((e.velocity.x * e.velocity.x * e.mass) / this.mass) *
              (e.velocity.x > 0 ? 1 : -1),
            n =
              Math.sqrt(
                (this.velocity.x * this.velocity.x * this.mass) / e.mass
          ...
          (t -= r),
            ...
            (e.velocity.x = n),
            (t =
              Math.sqrt((e.velocity.y * e.velocity.y * e.mass) / this.mass) *
              (e.velocity.y > 0 ? 1 : -1)),
            (n =
              Math.sqrt(
                (this.velocity.y * this.velocity.y * this.mass) / e.mass
      ...
      processRebound: function (e) {
        (this._vx <= 0 && this.velocity.x > 0) ||
          (this._vx >= 0 && this.velocity.x < 0) ||
          (this.velocity.x = e.velocity.x - this.velocity.x * this.bounce.x),
          (this._vy <= 0 && this.velocity.y > 0) ||
            (this._vy >= 0 && this.velocity.y < 0) ||
            (this.velocity.y = e.velocity.y - this.velocity.y * this.bounce.y),
          (this.angle = Math.atan2(this.velocity.y, this.velocity.x)),
          this.reboundCheck(!0, !0, !1);
      },
      overlap: function (e, t) {
        ...
        return (
          (this.type !== n.Physics.Arcade.RECT &&
            this.type !== n.Physics.Arcade.POLYGON) ||
          (e.type !== n.Physics.Arcade.RECT &&
            e.type !== n.Physics.Arcade.POLYGON)
            ? this.type === n.Physics.Arcade.CIRCLE &&
              e.type === n.Physics.Arcade.CIRCLE
              ...
              ? this.type !== n.Physics.Arcade.CIRCLE ||
                (e.type !== n.Physics.Arcade.RECT &&
                  e.type !== n.Physics.Arcade.POLYGON) ||
                (r = SAT.testCirclePolygon(this.shape, e.polygon, t))
            ...
            : t.overlapN.y &&
              (this._distances[2] < this._distances[3]
                ...
                : this._distances[3] < this._distances[2] &&
                  (n = this.hitBottom(e, t))),
          n
            ? (this.game.physics.checkBounds(this),
              this.game.physics.checkBounds(e))
            : this.addContact(e),
          n
        );
      },
      hitLeft: function (e, t) {
        return this.checkCollision.left && e.checkCollision.right
          ? void (
              ...
              this.touching.right
                ? e.give(this, t)
                : e.immovable || e.blocked.left || e.touching.left
                ? this.take(e, t)
                : this.split(e, t),
      ...
      hitRight: function (e, t) {
        return this.checkCollision.right && e.checkCollision.left
          ? void (
              ...
              this.touching.left
                ? e.give(this, t)
                : e.immovable || e.blocked.right || e.touching.right
                ? this.take(e, t)
                : this.split(e, t),
        ...
        return this.checkCollision.up && e.checkCollision.down
          ? this.collideCallback &&
            ...
            : (!this.moves ||
              ...
              this.touching.down
                ? e.give(this, t)
                : e.immovable || e.blocked.up || e.touching.up
                ? this.take(e, t)
                : this.split(e, t),
              (this.touching.up = !0),
              (e.touching.down = !0),
        ...
        return this.checkCollision.down && e.checkCollision.up
          ? this.collideCallback &&
            ...
            : (!this.moves ||
              ...
              this.touching.up
                ? e.give(this, t)
                : e.immovable || e.blocked.down || e.touching.down
                ? this.take(e, t)
                : this.split(e, t),
      ...
      integrateVelocity: function () {
        (this._temp = this.game.physics.updateMotion(this)),
          ...
          ((this._dx < 0 && !this.blocked.left && !this.touching.left) ||
            (this._dx > 0 && !this.blocked.right && !this.touching.right)) &&
            ((this.x += this._dx), (this.velocity.x += this._temp.x)),
          ((this._dy < 0 && !this.blocked.up && !this.touching.up) ||
            (this._dy > 0 && !this.blocked.down && !this.touching.down)) &&
      ...
      postUpdate: function () {
        this.moves &&
          ...
          this._dx < 0
            ? (this.facing = n.LEFT)
            : this._dx > 0 && (this.facing = n.RIGHT),
          this._dy < 0
            ? (this.facing = n.UP)
            : this._dy > 0 && (this.facing = n.DOWN),
      ...
      setCircle: function (e, t, r) {
        "undefined" == typeof t && (t = this.sprite._cache.halfWidth),
          ...
          (this.shape = new SAT.Circle(
            new SAT.Vector(this.sprite.x, this.sprite.y),
            e
          )),
          (this.polygon = null),
      ...
      setRectangle: function (e, t, r, i) {
        "undefined" == typeof e && (e = this.sprite.width),
          ...
          (this.type = n.Physics.Arcade.RECT),
          (this.shape = new SAT.Box(
            new SAT.Vector(this.sprite.world.x, this.sprite.world.y),
            e,
            t
          )),
      ...
      setPolygon: function (e) {
        if (
          ...
          for (var t = [], r = 0, i = e.length; i > r; r += 2)
            t.push(new SAT.Vector(e[r], e[r + 1]));
          e = t;
        }
        (this.polygon = new SAT.Polygon(
          new SAT.Vector(this.sprite.center.x, this.sprite.center.y),
          e
        )),
          this.offset.setTo(0, 0);
      },
    ...
    Object.defineProperty(n.Physics.Arcade.Body.prototype, "x", {
      get: function () {
        return this.type === n.Physics.Arcade.CIRCLE
          ? this.shape.pos.x
          : this.polygon.pos.x;
      },
      set: function (e) {
    ...
    (n.Particles.Arcade.Emitter.prototype.constructor =
      n.Particles.Arcade.Emitter),
    ...
    (n.Particles.Arcade.Emitter.prototype.makeParticles = function (
      e,
      t,
      r,
      i,
      ...
      "undefined" == typeof t && (t = 0),
        "undefined" == typeof r && (r = this.maxParticles),
        "undefined" == typeof i && (i = !1),
        "undefined" == typeof s && (s = !1);
      for (var o, u = 0, a = e, f = t; r > u; )
        null === this.particleClass &&
          ("object" == typeof e && (a = this.game.rnd.pick(e)),
          "object" == typeof t && (f = this.game.rnd.pick(t)),
          (o = new n.Sprite(this.game, 0, 0, a, f))),
          i
            ? ((o.body.checkCollision.any = !0),
              (o.body.checkCollision.none = !1))
            : (o.body.checkCollision.none = !0),
    ...
    (n.Particles.Arcade.Emitter.prototype.emitParticle = function () {
      ...
      if (null != e) {
        if (
          ...
          var t = this.game.rnd.realInRange(
            this.minParticleScale,
            this.maxParticleScale
          );
          e.scale.setTo(t, t);
        }
        (e.body.friction = this.particleFriction),
    ...
    (n.Tilemap.prototype = {
      ...
      addTilesetImage: function (e, t) {
        ...
        return (
          ...
          this.tilesets[e]
            ? ((this.tilesets[e].image = this.game.cache.getImage(t)), !0)
            : !1
        );
      },
      ...
      createFromObjects: function (e, t, n, r, i, s, o) {
        ...
        for (var u, a = 0, f = this.objects[e].length; f > a; a++)
          if (this.objects[e][a].gid === t) {
            (u = o.create(this.objects[e][a].x, this.objects[e][a].y, n, r, i)),
              u.anchor.setTo(0, 1),
              (u.name = this.objects[e][a].name),
              (u.visible = this.objects[e][a].visible),
              (u.autoCull = s);
            for (property in this.objects[e][a].properties)
              o.set(
                u,
                property,
                this.objects[e][a].properties[property],
                !1,
                !1,
                0
              );
      ...
      createLayer: function (e, t, r, i) {
        "undefined" == typeof t && (t = this.game.width),
        ...
        return (
          ...
          null === s || s > this.layers.length
            ...
            : i.add(new n.TilemapLayer(this.game, this, s, t, r))
        );
      },
      ...
      getLayer: function (e) {
        return (
          "undefined" == typeof e
            ...
            : e instanceof n.TilemapLayer && (e = e.index),
          e
        );
      },
      ...
      putTile: function (e, t, r, i) {
        (i = this.getLayer(i)),
          t >= 0 &&
            ...
            (e instanceof n.Tile
              ? this.layers[i].data[r][t].copy(e)
              : (this.layers[i].data[r][t].index = e),
    ...
    (n.TilemapLayer.prototype = n.Utils.extend(
      !0,
      n.TilemapLayer.prototype,
      n.Sprite.prototype,
      t.Sprite.prototype
    )),
    (n.TilemapLayer.prototype.constructor = n.TilemapLayer),
    (n.TilemapLayer.prototype.postUpdate = function () {
      n.Sprite.prototype.postUpdate.call(this),
    ...
    (n.TilemapLayer.prototype._fixX = function (e) {
      return (
        ...
        1 === this.scrollFactorX
          ? e
          : this._x + (e - this._x / this.scrollFactorX)
      );
    }),
    (n.TilemapLayer.prototype._unfixX = function (e) {
      return 1 === this.scrollFactorX
        ? e
        : this._x / this.scrollFactorX + (e - this._x);
    }),
    (n.TilemapLayer.prototype._fixY = function (e) {
      return (
        ...
        1 === this.scrollFactorY
          ? e
          : this._y + (e - this._y / this.scrollFactorY)
      );
    }),
    (n.TilemapLayer.prototype._unfixY = function (e) {
      return 1 === this.scrollFactorY
        ? e
        : this._y / this.scrollFactorY + (e - this._y);
    }),
    ...
    (n.TilemapLayer.prototype.getTiles = function (e, t, n, r, i) {
      "undefined" == typeof i && (i = !1),
        ...
        (this._tw =
          (this.game.math.snapToCeil(n, this._cw) + this._cw) / this._cw),
        (this._th =
          (this.game.math.snapToCeil(r, this._ch) + this._ch) / this._ch),
        (this._results.length = 0);
      for (var s = this._ty; s < this._ty + this._th; s++)
        for (var o = this._tx; o < this._tx + this._tw; o++)
          if (
            this.layer.data[s] &&
            this.layer.data[s][o] &&
            (i === !1 || (i && this.layer.data[s][o].canCollide))
          ) {
            ...
            this._results.push({
              x: u * this._cw,
              y: a * this._ch,
              right: u * this._cw + this._cw,
              bottom: a * this._ch + this._ch,
              tile: this.layer.data[s][o],
              layer: this.layer.data[s][o].layer,
            });
          }
      return this._results;
    }),
              ...
              this.map.tiles[e.index] &&
                ...
                r.image
                  ? (this.debug === !1 &&
                    ...
                    r.tileWidth !== this.map.tileWidth ||
                    r.tileHeight !== this.map.tileHeight
      ...
      for (var e = this._startY, t = this._startY + this._maxY; t > e; e++) {
        ...
        for (var n = this._startX, r = this._startX + this._maxX; r > n; n++) {
          ...
          i &&
            ...
            this.context.stroke()),
            i &&
              (i.collisionCallback || i.layer.callbacks[i.index]) &&
    ...
    (n.TilemapParser = {
        ...
        return (
          ...
          0 === c || 0 === h || r > c || i > h || 0 === f
            ? (console.warn(
              ...
              null)
            : new n.Tileset(l, t, r, i, s, o, u, a, f)
        );
      },
      parse: function (e, t) {
        var r = e.cache.getTilemapData(t);
        return r
          ? r.format === n.Tilemap.CSV
            ? this.parseCSV(r.data)
            : r.format === n.Tilemap.TILED_JSON
            ? this.parseTiledJSON(r.data)
            : void 0
          : {
              layers: [],
              objects: [],
      ...
      parseCSV: function (e) {
        ...
        for (
          ...
          t[s] = [];
          for (var o = n[s].split(","), u = 0; u < o.length; u++)
            t[s][u] = parseInt(o[u], 10);
          0 === i && (i = o.length);
        }
        return [
          {
        ...
        for (var i = 0; i < t.tilesets.length; i++)
          for (
            var g = t.tilesets[i],
              ...
              S = 0,
              f = g.firstgid;
            f < g.firstgid + g.total &&
            ((t.tiles[f] = [o, b, i]),
            (o += g.tileWidth + g.tileSpacing),
            w++,
            w !== g.total) &&
            (E++,
            E !== g.columns ||
              ((o = g.tileMargin),
              (b += g.tileHeight + g.tileSpacing),
              (E = 0),
              S++,
              S !== g.rows));
            f++
          ...
          if (e.renderable && 0 !== e.alpha) {
            if (e instanceof t.Sprite)
              e.texture.frame &&
                ...
                n.CANVAS_PX_ROUND
                  ? this.context.setTransform(
                      ...
                      e.worldTransform[1],
                      e.worldTransform[4],
                      Math.floor(e.worldTransform[2]),
                      Math.floor(e.worldTransform[5])
                    )
                  : this.context.setTransform(
                      e.worldTransform[0],
                      e.worldTransform[3],
              ...
              this.context.setTransform(
                ...
                t.CanvasGraphics.renderGraphics(e, this.context);
      ...
      for (
        ...
        if (y.vcount === t.visibleCount) {
          if (
            ...
            (m = e[5]),
            y.texture.trimmed &&
              ((v += y.texture.trim.x), (m += y.texture.trim.y)),
    ...
    (a = function (e, t) {
      ...
      return (
        ...
        deadTubeTops.length > 0 && "tubeTop" === i
          ...
          : ((n = tubes.create(r.world.width, s, i)),
      ...
      (f = function () {
        ...
        tubes.forEachAlive(function (e) {
          e.x + e.width < r.world.bounds.left &&
            ("tubeTop" === e.key && deadTubeTops.push(e.kill()),
            "tubeBottom" === e.key && deadTubeBottoms.push(e.kill()));
        }),
          invs.forEachAlive(function (e) {
            e.x + e.width < r.world.bounds.left && deadInvs.push(e.kill());
          }),
          (i =
            r.world.height / 2 + (Math.random() - 0.5) * r.world.height * 0.2),
          (e = a(i)),
          (n = a(i, !0)),
          deadInvs.length > 0
            ? (t = deadInvs
            ...
            : ((t = invs.create(n.x + n.width / 2, 0)),
              (t.width = 2),
              (t.height = r.world.height),
              (t.body.allowGravity = !1)),
      ...
      (u = function () {
        ...
        (gameOver = !0),
          ...
          (instText.renderable = !0),
          (e = window.localStorage.getItem("hiscore")),
          (e = e ? e : score),
          (e = score > parseInt(e, 10) ? score : e),
          window.localStorage.setItem("hiscore", e),
          ...
          r.time.events.add(1e3, function () {
      ...
      (n = function () {
        ...
        gameStarted || l(),
          gameOver ||
            ...
            (e = r.add.tween(bird.body.velocity).to(
              {
                y: -FLAP,
              },
              25,
      ...
      (i = function () {
        ...
        (e = {
          spritesheet: {
            bird: [bird_picture, 36, 26],
          },
          image: {
            tubeTop: [tube1_picture],
            tubeBottom: [tube2_picture],
            ground: [ground_picture],
            bg: [bg_picture],
          },
          audio: {
            flap: [wing_sfx],
      ...
      (t = function () {
        var e;
        console.log("Build by Piecesnbits"),
          (e = window.innerWidth / window.innerHeight),
          (e > 1.15 || 0.7 > e) &&
            (document.querySelector("#loading").style.display = "none"),
          Phaser.Canvas.setSmoothingEnabled(r.context, !1),
          (r.stage.scaleMode = Phaser.StageScaleMode.SHOW_ALL),
          r.stage.scale.setScreenSize(!0),
          (r.world.width = WIDTH),
          ...
          bird.animations.add("fly", [0, 1, 2], 10, !0),
          (bird.body.collideWorldBounds = !0),
          ...
          (scoreText = r.add.text(r.world.width / 2, r.world.height / 4, "", {
          ...
          (instText = r.add.text(
            r.world.width / 2,
            r.world.height - r.world.height / 4,
            "",
            {
      ...
      (o = function () {
        (gameStarted = !1),
          ...
          (gameOverText.renderable = !1),
          (bird.body.allowGravity = !1),
      ...
      (l = function () {
        (bird.body.allowGravity = !0),
          (bird.body.gravity.y = GRAVITY),
          (tubesTimer = r.time.events.loop(1 / SPAWN_RATE, f)),
          scoreText.setText(score),
          (instText.renderable = !1),
          (gameStarted = !0);
      }),
      (h = function () {
        var t;
        gameStarted
          ? gameOver
            ? ((t = r.add.tween(bird).to(
              ...
              bird.body.bottom >= GROUND_Y + 3 &&
                ((bird.y = GROUND_Y - 13),
                (bird.body.velocity.y = 0),
                (bird.body.allowGravity = !1),
                (bird.body.gravity.y = 0)))
            : ((bird.angle = (90 * (FLAP + bird.body.velocity.y)) / FLAP - 180),
              bird.angle < -30 && (bird.angle = -30),
              bird.angle > 80
                ? ((bird.angle = 90), bird.animations.stop(), (bird.frame = 1))
                : bird.animations.play(),
              r.physics.overlap(bird, tubes, function () {
                return u(), fallSnd.play();
              }),
              !gameOver && bird.body.bottom >= GROUND_Y && u(),
              r.physics.overlap(bird, invs, e))
          : ((bird.y = r.world.height / 2 + 8 * Math.cos(r.time.now / 200)),
            (bird.angle = 0)),
          gameOver || (ground.tilePosition.x -= r.time.physicsElapsed * SPEED);
      }),
      (s = function () {
        DEBUG &&
